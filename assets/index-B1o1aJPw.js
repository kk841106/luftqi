...
* @license MIT
**/function Du(t,e){const n=new Set(t.split(","));return e?i=>n.has(i.toLowerCase()):i=>n.has(i)}const yt={},rr=[],Rn=()=>{},Gg=()=>!1,Za=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),Iu=t=>t.startsWith("onUpdate:"),Qt=Object.assign,Uu=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Wg=Object.prototype.hasOwnProperty,rt=(t,e)=>Wg.call(t,e),Ve=Array.isArray,or=t=>mo(t)==="[object Map]",Ja=t=>mo(t)==="[object Set]",Bd=t=>mo(t)==="[object Date]",Ze=t=>typeof t=="function",Ut=t=>typeof t=="string",ns=t=>typeof t=="symbol",xt=t=>t!==null&&typeof t=="object",Kh=t=>(xt(t)||Ze(t))&&Ze(t.then)&&Ze(t.catch),Zh=Object.prototype.toString,mo=t=>Zh.call(t),$g=t=>mo(t).slice(8,-1),Jh=t=>mo(t)==="[object Object]",Nu=t=>Ut(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,jr=Du(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qa=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Xg=/-(\w)/g,pr=Qa(t=>t.replace(Xg,(e,n)=>n?n.toUpperCase():"")),qg=/\B([A-Z])/g,Sr=Qa(t=>t.replace(qg,"-$1").toLowerCase()),Qh=Qa(t=>t.charAt(0).toUpperCase()+t.slice(1)),Al=Qa(t=>t?`on${Qh(t)}`:""),is=(t,e)=>!Object.is(t,e),ha=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Aa=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},to=t=>{const e=parseFloat(t);return isNaN(e)?t:e},Yg=t=>{const e=Ut(t)?Number(t):NaN;return isNaN(e)?t:e};let kd;const ep=()=>kd||(kd=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function _i(t){if(Ve(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],s=Ut(i)?Jg(i):_i(i);if(s)for(const r in s)e[r]=s[r]}return e}else if(Ut(t)||xt(t))return t}const jg=/;(?![^(]*\))/g,Kg=/:([^]+)/,Zg=/\/\*[^]*?\*\//g;function Jg(t){const e={};return t.replace(Zg,"").split(jg).forEach(n=>{if(n){const i=n.split(Kg);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function It(t){let e="";if(Ut(t))e=t;else if(Ve(t))for(let n=0;n<t.length;n++){const i=It(t[n]);i&&(e+=i+" ")}else if(xt(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Qg="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",e_=Du(Qg);function tp(t){return!!t||t===""}function t_(t,e){if(t.length!==e.length)return!1;let n=!0;for(let i=0;n&&i<t.length;i++)n=el(t[i],e[i]);return n}function el(t,e){if(t===e)return!0;let n=Bd(t),i=Bd(e);if(n||i)return n&&i?t.getTime()===e.getTime():!1;if(n=ns(t),i=ns(e),n||i)return t===e;if(n=Ve(t),i=Ve(e),n||i)return n&&i?t_(t,e):!1;if(n=xt(t),i=xt(e),n||i){if(!n||!i)return!1;const s=Object.keys(t).length,r=Object.keys(e).length;if(s!==r)return!1;for(const o in t){const a=t.hasOwnProperty(o),l=e.hasOwnProperty(o);if(a&&!l||!a&&l||!el(t[o],e[o]))return!1}}return String(t)===String(e)}function n_(t,e){return t.findIndex(n=>el(n,e))}const un=t=>Ut(t)?t:t==null?"":Ve(t)||xt(t)&&(t.toString===Zh||!Ze(t.toString))?JSON.stringify(t,np,2):String(t),np=(t,e)=>e&&e.__v_isRef?np(t,e.value):or(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,s],r)=>(n[Cl(i,r)+" =>"]=s,n),{})}:Ja(e)?{[`Set(${e.size})`]:[...e.values()].map(n=>Cl(n))}:ns(e)?Cl(e):xt(e)&&!Ve(e)&&!Jh(e)?String(e):e,Cl=(t,e="")=>{var n;return ns(t)?`Symbol(${(n=t.description)!=null?n:e})`:t};/**
* @vue/reactivity v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let On;class ip{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=On,!e&&On&&(this.index=(On.scopes||(On.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=On;try{return On=this,e()}finally{On=n}}}on(){On=this}off(){On=this.parent}stop(e){if(this._active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function i_(t){return new ip(t)}function s_(t,e=On){e&&e.active&&e.effects.push(t)}function r_(){return On}let Ps;class Fu{constructor(e,n,i,s){this.fn=e,this.trigger=n,this.scheduler=i,this.active=!0,this.deps=[],this._dirtyLevel=4,this._trackId=0,this._runnings=0,this._shouldSchedule=!1,this._depsLength=0,s_(this,s)}get dirty(){if(this._dirtyLevel===2||this._dirtyLevel===3){this._dirtyLevel=1,Ns();for(let e=0;e<this._depsLength;e++){const n=this.deps[e];if(n.computed&&(o_(n.computed),this._dirtyLevel>=4))break}this._dirtyLevel===1&&(this._dirtyLevel=0),Fs()}return this._dirtyLevel>=4}set dirty(e){this._dirtyLevel=e?4:0}run(){if(this._dirtyLevel=0,!this.active)return this.fn();let e=Qi,n=Ps;try{return Qi=!0,Ps=this,this._runnings++,zd(this),this.fn()}finally{Vd(this),this._runnings--,Ps=n,Qi=e}}stop(){var e;this.active&&(zd(this),Vd(this),(e=this.onStop)==null||e.call(this),this.active=!1)}}function o_(t){return t.value}function zd(t){t._trackId++,t._depsLength=0}function Vd(t){if(t.deps.length>t._depsLength){for(let e=t._depsLength;e<t.deps.length;e++)sp(t.deps[e],t);t.deps.length=t._depsLength}}function sp(t,e){const n=t.get(e);n!==void 0&&e._trackId!==n&&(t.delete(e),t.size===0&&t.cleanup())}let Qi=!0,yc=0;const rp=[];function Ns(){rp.push(Qi),Qi=!1}function Fs(){const t=rp.pop();Qi=t===void 0?!0:t}function Ou(){yc++}function Bu(){for(yc--;!yc&&Sc.length;)Sc.shift()()}function op(t,e,n){if(e.get(t)!==t._trackId){e.set(t,t._trackId);const i=t.deps[t._depsLength];i!==e?(i&&sp(i,t),t.deps[t._depsLength++]=e):t._depsLength++}}const Sc=[];function ap(t,e,n){Ou();for(const i of t.keys()){let s;i._dirtyLevel<e&&(s??(s=t.get(i)===i._trackId))&&(i._shouldSchedule||(i._shouldSchedule=i._dirtyLevel===0),i._dirtyLevel=e),i._shouldSchedule&&(s??(s=t.get(i)===i._trackId))&&(i.trigger(),(!i._runnings||i.allowRecurse)&&i._dirtyLevel!==2&&(i._shouldSchedule=!1,i.scheduler&&Sc.push(i.scheduler)))}Bu()}const lp=(t,e)=>{const n=new Map;return n.cleanup=t,n.computed=e,n},Mc=new WeakMap,Ls=Symbol(""),Ec=Symbol("");function hn(t,e,n){if(Qi&&Ps){let i=Mc.get(t);i||Mc.set(t,i=new Map);let s=i.get(n);s||i.set(n,s=lp(()=>i.delete(n))),op(Ps,s)}}function bi(t,e,n,i,s,r){const o=Mc.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&Ve(t)){const l=Number(i);o.forEach((c,u)=>{(u==="length"||!ns(u)&&u>=l)&&a.push(c)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":Ve(t)?Nu(n)&&a.push(o.get("length")):(a.push(o.get(Ls)),or(t)&&a.push(o.get(Ec)));break;case"delete":Ve(t)||(a.push(o.get(Ls)),or(t)&&a.push(o.get(Ec)));break;case"set":or(t)&&a.push(o.get(Ls));break}Ou();for(const l of a)l&&ap(l,4);Bu()}const a_=Du("__proto__,__v_isRef,__isVue"),cp=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(ns)),Hd=l_();function l_(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=ut(this);for(let r=0,o=this.length;r<o;r++)hn(i,"get",r+"");const s=i[e](...n);return s===-1||s===!1?i[e](...n.map(ut)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Ns(),Ou();const i=ut(this)[e].apply(this,n);return Bu(),Fs(),i}}),t}function c_(t){const e=ut(this);return hn(e,"has",t),e.hasOwnProperty(t)}class up{constructor(e=!1,n=!1){this._isReadonly=e,this._isShallow=n}get(e,n,i){const s=this._isReadonly,r=this._isShallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return r;if(n==="__v_raw")return i===(s?r?y_:pp:r?hp:fp).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const o=Ve(e);if(!s){if(o&&rt(Hd,n))return Reflect.get(Hd,n,i);if(n==="hasOwnProperty")return c_}const a=Reflect.get(e,n,i);return(ns(n)?cp.has(n):a_(n))||(s||hn(e,"get",n),r)?a:pn(a)?o&&Nu(n)?a:a.value:xt(a)?s?mp(a):nl(a):a}}class dp extends up{constructor(e=!1){super(!1,e)}set(e,n,i,s){let r=e[n];if(!this._isShallow){const l=mr(r);if(!Ca(i)&&!mr(i)&&(r=ut(r),i=ut(i)),!Ve(e)&&pn(r)&&!pn(i))return l?!1:(r.value=i,!0)}const o=Ve(e)&&Nu(n)?Number(n)<e.length:rt(e,n),a=Reflect.set(e,n,i,s);return e===ut(s)&&(o?is(i,r)&&bi(e,"set",n,i):bi(e,"add",n,i)),a}deleteProperty(e,n){const i=rt(e,n);e[n];const s=Reflect.deleteProperty(e,n);return s&&i&&bi(e,"delete",n,void 0),s}has(e,n){const i=Reflect.has(e,n);return(!ns(n)||!cp.has(n))&&hn(e,"has",n),i}ownKeys(e){return hn(e,"iterate",Ve(e)?"length":Ls),Reflect.ownKeys(e)}}class u_ extends up{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const d_=new dp,f_=new u_,h_=new dp(!0),ku=t=>t,tl=t=>Reflect.getPrototypeOf(t);function Ro(t,e,n=!1,i=!1){t=t.__v_raw;const s=ut(t),r=ut(e);n||(is(e,r)&&hn(s,"get",e),hn(s,"get",r));const{has:o}=tl(s),a=i?ku:n?Gu:no;if(o.call(s,e))return a(t.get(e));if(o.call(s,r))return a(t.get(r));t!==s&&t.get(e)}function Po(t,e=!1){const n=this.__v_raw,i=ut(n),s=ut(t);return e||(is(t,s)&&hn(i,"has",t),hn(i,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function Lo(t,e=!1){return t=t.__v_raw,!e&&hn(ut(t),"iterate",Ls),Reflect.get(t,"size",t)}function Gd(t){t=ut(t);const e=ut(this);return tl(e).has.call(e,t)||(e.add(t),bi(e,"add",t,t)),this}function Wd(t,e){e=ut(e);const n=ut(this),{has:i,get:s}=tl(n);let r=i.call(n,t);r||(t=ut(t),r=i.call(n,t));const o=s.call(n,t);return n.set(t,e),r?is(e,o)&&bi(n,"set",t,e):bi(n,"add",t,e),this}function $d(t){const e=ut(this),{has:n,get:i}=tl(e);let s=n.call(e,t);s||(t=ut(t),s=n.call(e,t)),i&&i.call(e,t);const r=e.delete(t);return s&&bi(e,"delete",t,void 0),r}function Xd(){const t=ut(this),e=t.size!==0,n=t.clear();return e&&bi(t,"clear",void 0,void 0),n}function Do(t,e){return function(i,s){const r=this,o=r.__v_raw,a=ut(o),l=e?ku:t?Gu:no;return!t&&hn(a,"iterate",Ls),o.forEach((c,u)=>i.call(s,l(c),l(u),r))}}function Io(t,e,n){return function(...i){const s=this.__v_raw,r=ut(s),o=or(r),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=s[t](...i),u=n?ku:e?Gu:no;return!e&&hn(r,"iterate",l?Ec:Ls),{next(){const{value:f,done:d}=c.next();return d?{value:f,done:d}:{value:a?[u(f[0]),u(f[1])]:u(f),done:d}},[Symbol.iterator](){return this}}}}function Di(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function p_(){const t={get(r){return Ro(this,r)},get size(){return Lo(this)},has:Po,add:Gd,set:Wd,delete:$d,clear:Xd,forEach:Do(!1,!1)},e={get(r){return Ro(this,r,!1,!0)},get size(){return Lo(this)},has:Po,add:Gd,set:Wd,delete:$d,clear:Xd,forEach:Do(!1,!0)},n={get(r){return Ro(this,r,!0)},get size(){return Lo(this,!0)},has(r){return Po.call(this,r,!0)},add:Di("add"),set:Di("set"),delete:Di("delete"),clear:Di("clear"),forEach:Do(!0,!1)},i={get(r){return Ro(this,r,!0,!0)},get size(){return Lo(this,!0)},has(r){return Po.call(this,r,!0)},add:Di("add"),set:Di("set"),delete:Di("delete"),clear:Di("clear"),forEach:Do(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Io(r,!1,!1),n[r]=Io(r,!0,!1),e[r]=Io(r,!1,!0),i[r]=Io(r,!0,!0)}),[t,n,e,i]}const[m_,g_,__,v_]=p_();function zu(t,e){const n=e?t?v_:__:t?g_:m_;return(i,s,r)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(rt(n,s)&&s in i?n:i,s,r)}const x_={get:zu(!1,!1)},b_={get:zu(!1,!0)},w_={get:zu(!0,!1)},fp=new WeakMap,hp=new WeakMap,pp=new WeakMap,y_=new WeakMap;function S_(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function M_(t){return t.__v_skip||!Object.isExtensible(t)?0:S_($g(t))}function nl(t){return mr(t)?t:Vu(t,!1,d_,x_,fp)}function E_(t){return Vu(t,!1,h_,b_,hp)}function mp(t){return Vu(t,!0,f_,w_,pp)}function Vu(t,e,n,i,s){if(!xt(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=s.get(t);if(r)return r;const o=M_(t);if(o===0)return t;const a=new Proxy(t,o===2?i:n);return s.set(t,a),a}function ar(t){return mr(t)?ar(t.__v_raw):!!(t&&t.__v_isReactive)}function mr(t){return!!(t&&t.__v_isReadonly)}function Ca(t){return!!(t&&t.__v_isShallow)}function gp(t){return ar(t)||mr(t)}function ut(t){const e=t&&t.__v_raw;return e?ut(e):t}function Hu(t){return Object.isExtensible(t)&&Aa(t,"__v_skip",!0),t}const no=t=>xt(t)?nl(t):t,Gu=t=>xt(t)?mp(t):t;class _p{constructor(e,n,i,s){this.getter=e,this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this.effect=new Fu(()=>e(this._value),()=>pa(this,this.effect._dirtyLevel===2?2:3)),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=i}get value(){const e=ut(this);return(!e._cacheable||e.effect.dirty)&&is(e._value,e._value=e.effect.run())&&pa(e,4),vp(e),e.effect._dirtyLevel>=2&&pa(e,2),e._value}set value(e){this._setter(e)}get _dirty(){return this.effect.dirty}set _dirty(e){this.effect.dirty=e}}function T_(t,e,n=!1){let i,s;const r=Ze(t);return r?(i=t,s=Rn):(i=t.get,s=t.set),new _p(i,s,r||!s,n)}function vp(t){var e;Qi&&Ps&&(t=ut(t),op(Ps,(e=t.dep)!=null?e:t.dep=lp(()=>t.dep=void 0,t instanceof _p?t:void 0)))}function pa(t,e=4,n){t=ut(t);const i=t.dep;i&&ap(i,e)}function pn(t){return!!(t&&t.__v_isRef===!0)}function et(t){return A_(t,!1)}function A_(t,e){return pn(t)?t:new C_(t,e)}class C_{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ut(e),this._value=n?e:no(e)}get value(){return vp(this),this._value}set value(e){const n=this.__v_isShallow||Ca(e)||mr(e);e=n?e:ut(e),is(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:no(e),pa(this,4))}}function ws(t){return pn(t)?t.value:t}const R_={get:(t,e,n)=>ws(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const s=t[e];return pn(s)&&!pn(n)?(s.value=n,!0):Reflect.set(t,e,n,i)}};function xp(t){return ar(t)?t:new Proxy(t,R_)}/**
* @vue/runtime-core v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function es(t,e,n,i){try{return i?t(...i):t()}catch(s){il(s,e,n)}}function Pn(t,e,n,i){if(Ze(t)){const r=es(t,e,n,i);return r&&Kh(r)&&r.catch(o=>{il(o,e,n)}),r}const s=[];for(let r=0;r<t.length;r++)s.push(Pn(t[r],e,n,i));return s}function il(t,e,n,i=!0){const s=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=`https://vuejs.org/error-reference/#runtime-${n}`;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}r=r.parent}const l=e.appContext.config.errorHandler;if(l){es(l,null,10,[t,o,a]);return}}P_(t,n,s,i)}function P_(t,e,n,i=!0){console.error(t)}let io=!1,Tc=!1;const jt=[];let Kn=0;const lr=[];let Hi=null,ys=0;const bp=Promise.resolve();let Wu=null;function Ra(t){const e=Wu||bp;return t?e.then(this?t.bind(this):t):e}function L_(t){let e=Kn+1,n=jt.length;for(;e<n;){const i=e+n>>>1,s=jt[i],r=so(s);r<t||r===t&&s.pre?e=i+1:n=i}return e}function $u(t){(!jt.length||!jt.includes(t,io&&t.allowRecurse?Kn+1:Kn))&&(t.id==null?jt.push(t):jt.splice(L_(t.id),0,t),wp())}function wp(){!io&&!Tc&&(Tc=!0,Wu=bp.then(Sp))}function D_(t){const e=jt.indexOf(t);e>Kn&&jt.splice(e,1)}function I_(t){Ve(t)?lr.push(...t):(!Hi||!Hi.includes(t,t.allowRecurse?ys+1:ys))&&lr.push(t),wp()}function qd(t,e,n=io?Kn+1:0){for(;n<jt.length;n++){const i=jt[n];if(i&&i.pre){if(t&&i.id!==t.uid)continue;jt.splice(n,1),n--,i()}}}function yp(t){if(lr.length){const e=[...new Set(lr)].sort((n,i)=>so(n)-so(i));if(lr.length=0,Hi){Hi.push(...e);return}for(Hi=e,ys=0;ys<Hi.length;ys++)Hi[ys]();Hi=null,ys=0}}const so=t=>t.id==null?1/0:t.id,U_=(t,e)=>{const n=so(t)-so(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Sp(t){Tc=!1,io=!0,jt.sort(U_);try{for(Kn=0;Kn<jt.length;Kn++){const e=jt[Kn];e&&e.active!==!1&&es(e,null,14)}}finally{Kn=0,jt.length=0,yp(),io=!1,Wu=null,(jt.length||lr.length)&&Sp()}}function N_(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||yt;let s=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:f,trim:d}=i[u]||yt;d&&(s=n.map(p=>Ut(p)?p.trim():p)),f&&(s=n.map(to))}let a,l=i[a=Al(e)]||i[a=Al(pr(e))];!l&&r&&(l=i[a=Al(Sr(e))]),l&&Pn(l,t,6,s);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Pn(c,t,6,s)}}function Mp(t,e,n=!1){const i=e.emitsCache,s=i.get(t);if(s!==void 0)return s;const r=t.emits;let o={},a=!1;if(!Ze(t)){const l=c=>{const u=Mp(c,e,!0);u&&(a=!0,Qt(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!r&&!a?(xt(t)&&i.set(t,null),null):(Ve(r)?r.forEach(l=>o[l]=null):Qt(o,r),xt(t)&&i.set(t,o),o)}function sl(t,e){return!t||!Za(e)?!1:(e=e.slice(2).replace(/Once$/,""),rt(t,e[0].toLowerCase()+e.slice(1))||rt(t,Sr(e))||rt(t,e))}let zt=null,rl=null;function Pa(t){const e=zt;return zt=t,rl=t&&t.type.__scopeId||null,e}function Ai(t){rl=t}function Ci(){rl=null}function Cn(t,e=zt,n){if(!e||t._n)return t;const i=(...s)=>{i._d&&of(-1);const r=Pa(e);let o;try{o=t(...s)}finally{Pa(r),i._d&&of(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function Yd(t){const{type:e,vnode:n,proxy:i,withProxy:s,props:r,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:f,data:d,setupState:p,ctx:_,inheritAttrs:x}=t;let m,h;const y=Pa(t);try{if(n.shapeFlag&4){const A=s||i,D=A;m=Yn(u.call(D,A,f,r,p,d,_)),h=l}else{const A=e;m=Yn(A.length>1?A(r,{attrs:l,slots:a,emit:c}):A(r,null)),h=e.props?l:F_(l)}}catch(A){Qr.length=0,il(A,t,1),m=st(Ln)}let E=m;if(h&&x!==!1){const A=Object.keys(h),{shapeFlag:D}=E;A.length&&D&7&&(o&&A.some(Iu)&&(h=O_(h,o)),E=ss(E,h))}return n.dirs&&(E=ss(E),E.dirs=E.dirs?E.dirs.concat(n.dirs):n.dirs),n.transition&&(E.transition=n.transition),m=E,Pa(y),m}const F_=t=>{let e;for(const n in t)(n==="class"||n==="style"||Za(n))&&((e||(e={}))[n]=t[n]);return e},O_=(t,e)=>{const n={};for(const i in t)(!Iu(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function B_(t,e,n){const{props:i,children:s,component:r}=t,{props:o,children:a,patchFlag:l}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?jd(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const d=u[f];if(o[d]!==i[d]&&!sl(c,d))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?jd(i,o,c):!0:!!o;return!1}function jd(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(e[r]!==t[r]&&!sl(n,r))return!0}return!1}function k_({vnode:t,parent:e},n){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===t&&(i.el=t.el),i===t)(t=e.vnode).el=n,e=e.parent;else break}}const z_=Symbol.for("v-ndc"),V_=t=>t.__isSuspense;function H_(t,e){e&&e.pendingBranch?Ve(t)?e.effects.push(...t):e.effects.push(t):I_(t)}const G_=Symbol.for("v-scx"),W_=()=>ma(G_),Uo={};function Zn(t,e,n){return Ep(t,e,n)}function Ep(t,e,{immediate:n,deep:i,flush:s,once:r,onTrack:o,onTrigger:a}=yt){if(e&&r){const R=e;e=(...I)=>{R(...I),D()}}const l=Kt,c=R=>i===!0?R:As(R,i===!1?1:void 0);let u,f=!1,d=!1;if(pn(t)?(u=()=>t.value,f=Ca(t)):ar(t)?(u=()=>c(t),f=!0):Ve(t)?(d=!0,f=t.some(R=>ar(R)||Ca(R)),u=()=>t.map(R=>{if(pn(R))return R.value;if(ar(R))return c(R);if(Ze(R))return es(R,l,2)})):Ze(t)?e?u=()=>es(t,l,2):u=()=>(p&&p(),Pn(t,l,3,[_])):u=Rn,e&&i){const R=u;u=()=>As(R())}let p,_=R=>{p=E.onStop=()=>{es(R,l,4),p=E.onStop=void 0}},x;if(dl)if(_=Rn,e?n&&Pn(e,l,3,[u(),d?[]:void 0,_]):u(),s==="sync"){const R=W_();x=R.__watcherHandles||(R.__watcherHandles=[])}else return Rn;let m=d?new Array(t.length).fill(Uo):Uo;const h=()=>{if(!(!E.active||!E.dirty))if(e){const R=E.run();(i||f||(d?R.some((I,v)=>is(I,m[v])):is(R,m)))&&(p&&p(),Pn(e,l,3,[R,m===Uo?void 0:d&&m[0]===Uo?[]:m,_]),m=R)}else E.run()};h.allowRecurse=!!e;let y;s==="sync"?y=h:s==="post"?y=()=>cn(h,l&&l.suspense):(h.pre=!0,l&&(h.id=l.uid),y=()=>$u(h));const E=new Fu(u,Rn,y),A=r_(),D=()=>{E.stop(),A&&Uu(A.effects,E)};return e?n?h():m=E.run():s==="post"?cn(E.run.bind(E),l&&l.suspense):E.run(),x&&x.push(D),D}function $_(t,e,n){const i=this.proxy,s=Ut(t)?t.includes(".")?Tp(i,t):()=>i[t]:t.bind(i,i);let r;Ze(e)?r=e:(r=e.handler,n=e);const o=_o(this),a=Ep(s,r.bind(i),n);return o(),a}function Tp(t,e){const n=e.split(".");return()=>{let i=t;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}function As(t,e,n=0,i){if(!xt(t)||t.__v_skip)return t;if(e&&e>0){if(n>=e)return t;n++}if(i=i||new Set,i.has(t))return t;if(i.add(t),pn(t))As(t.value,e,n,i);else if(Ve(t))for(let s=0;s<t.length;s++)As(t[s],e,n,i);else if(Ja(t)||or(t))t.forEach(s=>{As(s,e,n,i)});else if(Jh(t))for(const s in t)As(t[s],e,n,i);return t}function $r(t,e){if(zt===null)return t;const n=fl(zt)||zt.proxy,i=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[r,o,a,l=yt]=e[s];r&&(Ze(r)&&(r={mounted:r,updated:r}),r.deep&&As(o),i.push({dir:r,instance:n,value:o,oldValue:void 0,arg:a,modifiers:l}))}return t}function cs(t,e,n,i){const s=t.dirs,r=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];r&&(a.oldValue=r[o].value);let l=a.dir[i];l&&(Ns(),Pn(l,n,8,[t.el,a,t,e]),Fs())}}const Gi=Symbol("_leaveCb"),No=Symbol("_enterCb");function X_(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return go(()=>{t.isMounted=!0}),Xu(()=>{t.isUnmounting=!0}),t}const Mn=[Function,Array],Ap={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Mn,onEnter:Mn,onAfterEnter:Mn,onEnterCancelled:Mn,onBeforeLeave:Mn,onLeave:Mn,onAfterLeave:Mn,onLeaveCancelled:Mn,onBeforeAppear:Mn,onAppear:Mn,onAfterAppear:Mn,onAppearCancelled:Mn},q_={name:"BaseTransition",props:Ap,setup(t,{slots:e}){const n=D0(),i=X_();return()=>{const s=e.default&&Rp(e.default(),!0);if(!s||!s.length)return;let r=s[0];if(s.length>1){for(const d of s)if(d.type!==Ln){r=d;break}}const o=ut(t),{mode:a}=o;if(i.isLeaving)return Rl(r);const l=Kd(r);if(!l)return Rl(r);const c=Ac(l,o,i,n);Cc(l,c);const u=n.subTree,f=u&&Kd(u);if(f&&f.type!==Ln&&!Ss(l,f)){const d=Ac(f,o,i,n);if(Cc(f,d),a==="out-in")return i.isLeaving=!0,d.afterLeave=()=>{i.isLeaving=!1,n.update.active!==!1&&(n.effect.dirty=!0,n.update())},Rl(r);a==="in-out"&&l.type!==Ln&&(d.delayLeave=(p,_,x)=>{const m=Cp(i,f);m[String(f.key)]=f,p[Gi]=()=>{_(),p[Gi]=void 0,delete c.delayedLeave},c.delayedLeave=x})}return r}}},Y_=q_;function Cp(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function Ac(t,e,n,i){const{appear:s,mode:r,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:f,onLeave:d,onAfterLeave:p,onLeaveCancelled:_,onBeforeAppear:x,onAppear:m,onAfterAppear:h,onAppearCancelled:y}=e,E=String(t.key),A=Cp(n,t),D=(v,T)=>{v&&Pn(v,i,9,T)},R=(v,T)=>{const Q=T[1];D(v,T),Ve(v)?v.every(P=>P.length<=1)&&Q():v.length<=1&&Q()},I={mode:r,persisted:o,beforeEnter(v){let T=a;if(!n.isMounted)if(s)T=x||a;else return;v[Gi]&&v[Gi](!0);const Q=A[E];Q&&Ss(t,Q)&&Q.el[Gi]&&Q.el[Gi](),D(T,[v])},enter(v){let T=l,Q=c,P=u;if(!n.isMounted)if(s)T=m||l,Q=h||c,P=y||u;else return;let N=!1;const V=v[No]=ee=>{N||(N=!0,ee?D(P,[v]):D(Q,[v]),I.delayedLeave&&I.delayedLeave(),v[No]=void 0)};T?R(T,[v,V]):V()},leave(v,T){const Q=String(t.key);if(v[No]&&v[No](!0),n.isUnmounting)return T();D(f,[v]);let P=!1;const N=v[Gi]=V=>{P||(P=!0,T(),V?D(_,[v]):D(p,[v]),v[Gi]=void 0,A[Q]===t&&delete A[Q])};A[Q]=t,d?R(d,[v,N]):N()},clone(v){return Ac(v,e,n,i)}};return I}function Rl(t){if(ol(t))return t=ss(t),t.children=null,t}function Kd(t){return ol(t)?t.children?t.children[0]:void 0:t}function Cc(t,e){t.shapeFlag&6&&t.component?Cc(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Rp(t,e=!1,n){let i=[],s=0;for(let r=0;r<t.length;r++){let o=t[r];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:r);o.type===Lt?(o.patchFlag&128&&s++,i=i.concat(Rp(o.children,e,a))):(e||o.type!==Ln)&&i.push(a!=null?ss(o,{key:a}):o)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}const Kr=t=>!!t.type.__asyncLoader,ol=t=>t.type.__isKeepAlive;function j_(t,e){Pp(t,"a",e)}function K_(t,e){Pp(t,"da",e)}function Pp(t,e,n=Kt){const i=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(al(e,i,n),n){let s=n.parent;for(;s&&s.parent;)ol(s.parent.vnode)&&Z_(i,e,n,s),s=s.parent}}function Z_(t,e,n,i){const s=al(e,t,i,!0);ll(()=>{Uu(i[e],s)},n)}function al(t,e,n=Kt,i=!1){if(n){const s=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Ns();const a=_o(n),l=Pn(e,n,t,o);return a(),Fs(),l});return i?s.unshift(r):s.push(r),r}}const Ri=t=>(e,n=Kt)=>(!dl||t==="sp")&&al(t,(...i)=>e(...i),n),J_=Ri("bm"),go=Ri("m"),Q_=Ri("bu"),e0=Ri("u"),Xu=Ri("bum"),ll=Ri("um"),t0=Ri("sp"),n0=Ri("rtg"),i0=Ri("rtc");function s0(t,e=Kt){al("ec",t,e)}function Rc(t,e,n,i){let s;const r=n;if(Ve(t)||Ut(t)){s=new Array(t.length);for(let o=0,a=t.length;o<a;o++)s[o]=e(t[o],o,void 0,r)}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,r)}else if(xt(t))if(t[Symbol.iterator])s=Array.from(t,(o,a)=>e(o,a,void 0,r));else{const o=Object.keys(t);s=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];s[a]=e(t[c],c,a,r)}}else s=[];return s}function r0(t,e,n={},i,s){if(zt.isCE||zt.parent&&Kr(zt.parent)&&zt.parent.isCE)return st("slot",n,i);let r=t[e];r&&r._c&&(r._d=!1),$e();const o=r&&Lp(r(n)),a=Gp(Lt,{key:n.key||o&&o.key||`_${e}`},o||[],o&&t._===1?64:-2);return r&&r._c&&(r._d=!0),a}function Lp(t){return t.some(e=>Da(e)?!(e.type===Ln||e.type===Lt&&!Lp(e.children)):!0)?t:null}const Pc=t=>t?Xp(t)?fl(t)||t.proxy:Pc(t.parent):null,Zr=Qt(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Pc(t.parent),$root:t=>Pc(t.root),$emit:t=>t.emit,$options:t=>Ip(t),$forceUpdate:t=>t.f||(t.f=()=>{t.effect.dirty=!0,$u(t.update)}),$nextTick:t=>t.n||(t.n=Ra.bind(t.proxy)),$watch:t=>$_.bind(t)}),Pl=(t,e)=>t!==yt&&!t.__isScriptSetup&&rt(t,e),o0={get({_:t},e){const{ctx:n,setupState:i,data:s,props:r,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return s[e];case 4:return n[e];case 3:return r[e]}else{if(Pl(i,e))return o[e]=1,i[e];if(s!==yt&&rt(s,e))return o[e]=2,s[e];if((c=t.propsOptions[0])&&rt(c,e))return o[e]=3,r[e];if(n!==yt&&rt(n,e))return o[e]=4,n[e];Lc&&(o[e]=0)}}const u=Zr[e];let f,d;if(u)return e==="$attrs"&&hn(t,"get",e),u(t);if((f=a.__cssModules)&&(f=f[e]))return f;if(n!==yt&&rt(n,e))return o[e]=4,n[e];if(d=l.config.globalProperties,rt(d,e))return d[e]},set({_:t},e,n){const{data:i,setupState:s,ctx:r}=t;return Pl(s,e)?(s[e]=n,!0):i!==yt&&rt(i,e)?(i[e]=n,!0):rt(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:s,propsOptions:r}},o){let a;return!!n[o]||t!==yt&&rt(t,o)||Pl(e,o)||(a=r[0])&&rt(a,o)||rt(i,o)||rt(Zr,o)||rt(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:rt(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function Zd(t){return Ve(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let Lc=!0;function a0(t){const e=Ip(t),n=t.proxy,i=t.ctx;Lc=!1,e.beforeCreate&&Jd(e.beforeCreate,t,"bc");const{data:s,computed:r,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:d,beforeUpdate:p,updated:_,activated:x,deactivated:m,beforeDestroy:h,beforeUnmount:y,destroyed:E,unmounted:A,render:D,renderTracked:R,renderTriggered:I,errorCaptured:v,serverPrefetch:T,expose:Q,inheritAttrs:P,components:N,directives:V,filters:ee}=e;if(c&&l0(c,i,null),o)for(const O in o){const de=o[O];Ze(de)&&(i[O]=de.bind(n))}if(s){const O=s.call(n,n);xt(O)&&(t.data=nl(O))}if(Lc=!0,r)for(const O in r){const de=r[O],fe=Ze(de)?de.bind(n,n):Ze(de.get)?de.get.bind(n,n):Rn,ye=!Ze(de)&&Ze(de.set)?de.set.bind(n):Rn,ue=Ct({get:fe,set:ye});Object.defineProperty(i,O,{enumerable:!0,configurable:!0,get:()=>ue.value,set:he=>ue.value=he})}if(a)for(const O in a)Dp(a[O],i,n,O);if(l){const O=Ze(l)?l.call(n):l;Reflect.ownKeys(O).forEach(de=>{p0(de,O[de])})}u&&Jd(u,t,"c");function G(O,de){Ve(de)?de.forEach(fe=>O(fe.bind(n))):de&&O(de.bind(n))}if(G(J_,f),G(go,d),G(Q_,p),G(e0,_),G(j_,x),G(K_,m),G(s0,v),G(i0,R),G(n0,I),G(Xu,y),G(ll,A),G(t0,T),Ve(Q))if(Q.length){const O=t.exposed||(t.exposed={});Q.forEach(de=>{Object.defineProperty(O,de,{get:()=>n[de],set:fe=>n[de]=fe})})}else t.exposed||(t.exposed={});D&&t.render===Rn&&(t.render=D),P!=null&&(t.inheritAttrs=P),N&&(t.components=N),V&&(t.directives=V)}function l0(t,e,n=Rn){Ve(t)&&(t=Dc(t));for(const i in t){const s=t[i];let r;xt(s)?"default"in s?r=ma(s.from||i,s.default,!0):r=ma(s.from||i):r=ma(s),pn(r)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[i]=r}}function Jd(t,e,n){Pn(Ve(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Dp(t,e,n,i){const s=i.includes(".")?Tp(n,i):()=>n[i];if(Ut(t)){const r=e[t];Ze(r)&&Zn(s,r)}else if(Ze(t))Zn(s,t.bind(n));else if(xt(t))if(Ve(t))t.forEach(r=>Dp(r,e,n,i));else{const r=Ze(t.handler)?t.handler.bind(n):e[t.handler];Ze(r)&&Zn(s,r,t)}}function Ip(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let l;return a?l=a:!s.length&&!n&&!i?l=e:(l={},s.length&&s.forEach(c=>La(l,c,o,!0)),La(l,e,o)),xt(e)&&r.set(e,l),l}function La(t,e,n,i=!1){const{mixins:s,extends:r}=e;r&&La(t,r,n,!0),s&&s.forEach(o=>La(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=c0[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const c0={data:Qd,props:ef,emits:ef,methods:Xr,computed:Xr,beforeCreate:tn,created:tn,beforeMount:tn,mounted:tn,beforeUpdate:tn,updated:tn,beforeDestroy:tn,beforeUnmount:tn,destroyed:tn,unmounted:tn,activated:tn,deactivated:tn,errorCaptured:tn,serverPrefetch:tn,components:Xr,directives:Xr,watch:d0,provide:Qd,inject:u0};function Qd(t,e){return e?t?function(){return Qt(Ze(t)?t.call(this,this):t,Ze(e)?e.call(this,this):e)}:e:t}function u0(t,e){return Xr(Dc(t),Dc(e))}function Dc(t){if(Ve(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function tn(t,e){return t?[...new Set([].concat(t,e))]:e}function Xr(t,e){return t?Qt(Object.create(null),t,e):e}function ef(t,e){return t?Ve(t)&&Ve(e)?[...new Set([...t,...e])]:Qt(Object.create(null),Zd(t),Zd(e??{})):e}function d0(t,e){if(!t)return e;if(!e)return t;const n=Qt(Object.create(null),t);for(const i in e)n[i]=tn(t[i],e[i]);return n}function Up(){return{app:null,config:{isNativeTag:Gg,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let f0=0;function h0(t,e){return function(i,s=null){Ze(i)||(i=Qt({},i)),s!=null&&!xt(s)&&(s=null);const r=Up(),o=new WeakSet;let a=!1;const l=r.app={_uid:f0++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:k0,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&Ze(c.install)?(o.add(c),c.install(l,...u)):Ze(c)&&(o.add(c),c(l,...u))),l},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),l},component(c,u){return u?(r.components[c]=u,l):r.components[c]},directive(c,u){return u?(r.directives[c]=u,l):r.directives[c]},mount(c,u,f){if(!a){const d=st(i,s);return d.appContext=r,f===!0?f="svg":f===!1&&(f=void 0),t(d,c,f),a=!0,l._container=c,c.__vue_app__=l,fl(d.component)||d.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return r.provides[c]=u,l},runWithContext(c){const u=Jr;Jr=l;try{return c()}finally{Jr=u}}};return l}}let Jr=null;function p0(t,e){if(Kt){let n=Kt.provides;const i=Kt.parent&&Kt.parent.provides;i===n&&(n=Kt.provides=Object.create(i)),n[t]=e}}function ma(t,e,n=!1){const i=Kt||zt;if(i||Jr){const s=i?i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:Jr._context.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&Ze(e)?e.call(i&&i.proxy):e}}function m0(t,e,n,i=!1){const s={},r={};Aa(r,ul,1),t.propsDefaults=Object.create(null),Np(t,e,s,r);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=i?s:E_(s):t.type.props?t.props=s:t.props=r,t.attrs=r}function g0(t,e,n,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=t,a=ut(s),[l]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let f=0;f<u.length;f++){let d=u[f];if(sl(t.emitsOptions,d))continue;const p=e[d];if(l)if(rt(r,d))p!==r[d]&&(r[d]=p,c=!0);else{const _=pr(d);s[_]=Ic(l,a,_,p,t,!1)}else p!==r[d]&&(r[d]=p,c=!0)}}}else{Np(t,e,s,r)&&(c=!0);let u;for(const f in a)(!e||!rt(e,f)&&((u=Sr(f))===f||!rt(e,u)))&&(l?n&&(n[f]!==void 0||n[u]!==void 0)&&(s[f]=Ic(l,a,f,void 0,t,!0)):delete s[f]);if(r!==a)for(const f in r)(!e||!rt(e,f))&&(delete r[f],c=!0)}c&&bi(t,"set","$attrs")}function Np(t,e,n,i){const[s,r]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(jr(l))continue;const c=e[l];let u;s&&rt(s,u=pr(l))?!r||!r.includes(u)?n[u]=c:(a||(a={}))[u]=c:sl(t.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(r){const l=ut(n),c=a||yt;for(let u=0;u<r.length;u++){const f=r[u];n[f]=Ic(s,l,f,c[f],t,!rt(c,f))}}return o}function Ic(t,e,n,i,s,r){const o=t[n];if(o!=null){const a=rt(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&Ze(l)){const{propsDefaults:c}=s;if(n in c)i=c[n];else{const u=_o(s);i=c[n]=l.call(null,e),u()}}else i=l}o[0]&&(r&&!a?i=!1:o[1]&&(i===""||i===Sr(n))&&(i=!0))}return i}function Fp(t,e,n=!1){const i=e.propsCache,s=i.get(t);if(s)return s;const r=t.props,o={},a=[];let l=!1;if(!Ze(t)){const u=f=>{l=!0;const[d,p]=Fp(f,e,!0);Qt(o,d),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!l)return xt(t)&&i.set(t,rr),rr;if(Ve(r))for(let u=0;u<r.length;u++){const f=pr(r[u]);tf(f)&&(o[f]=yt)}else if(r)for(const u in r){const f=pr(u);if(tf(f)){const d=r[u],p=o[f]=Ve(d)||Ze(d)?{type:d}:Qt({},d);if(p){const _=rf(Boolean,p.type),x=rf(String,p.type);p[0]=_>-1,p[1]=x<0||_<x,(_>-1||rt(p,"default"))&&a.push(f)}}}const c=[o,a];return xt(t)&&i.set(t,c),c}function tf(t){return t[0]!=="$"&&!jr(t)}function nf(t){return t===null?"null":typeof t=="function"?t.name||"":typeof t=="object"&&t.constructor&&t.constructor.name||""}function sf(t,e){return nf(t)===nf(e)}function rf(t,e){return Ve(e)?e.findIndex(n=>sf(n,t)):Ze(e)&&sf(e,t)?0:-1}const Op=t=>t[0]==="_"||t==="$stable",qu=t=>Ve(t)?t.map(Yn):[Yn(t)],_0=(t,e,n)=>{if(e._n)return e;const i=Cn((...s)=>qu(e(...s)),n);return i._c=!1,i},Bp=(t,e,n)=>{const i=t._ctx;for(const s in t){if(Op(s))continue;const r=t[s];if(Ze(r))e[s]=_0(s,r,i);else if(r!=null){const o=qu(r);e[s]=()=>o}}},kp=(t,e)=>{const n=qu(e);t.slots.default=()=>n},v0=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ut(e),Aa(e,"_",n)):Bp(e,t.slots={})}else t.slots={},e&&kp(t,e);Aa(t.slots,ul,1)},x0=(t,e,n)=>{const{vnode:i,slots:s}=t;let r=!0,o=yt;if(i.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(Qt(s,e),!n&&a===1&&delete s._):(r=!e.$stable,Bp(e,s)),o=e}else e&&(kp(t,e),o={default:1});if(r)for(const a in s)!Op(a)&&o[a]==null&&delete s[a]};function Uc(t,e,n,i,s=!1){if(Ve(t)){t.forEach((d,p)=>Uc(d,e&&(Ve(e)?e[p]:e),n,i,s));return}if(Kr(i)&&!s)return;const r=i.shapeFlag&4?fl(i.component)||i.component.proxy:i.el,o=s?null:r,{i:a,r:l}=t,c=e&&e.r,u=a.refs===yt?a.refs={}:a.refs,f=a.setupState;if(c!=null&&c!==l&&(Ut(c)?(u[c]=null,rt(f,c)&&(f[c]=null)):pn(c)&&(c.value=null)),Ze(l))es(l,a,12,[o,u]);else{const d=Ut(l),p=pn(l);if(d||p){const _=()=>{if(t.f){const x=d?rt(f,l)?f[l]:u[l]:l.value;s?Ve(x)&&Uu(x,r):Ve(x)?x.includes(r)||x.push(r):d?(u[l]=[r],rt(f,l)&&(f[l]=u[l])):(l.value=[r],t.k&&(u[t.k]=l.value))}else d?(u[l]=o,rt(f,l)&&(f[l]=o)):p&&(l.value=o,t.k&&(u[t.k]=o))};o?(_.id=-1,cn(_,n)):_()}}}const cn=H_;function b0(t){return w0(t)}function w0(t,e){const n=ep();n.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:d,setScopeId:p=Rn,insertStaticContent:_}=t,x=(M,C,k,U=null,F=null,Y=null,S=void 0,ae=null,oe=!!C.dynamicChildren)=>{if(M===C)return;M&&!Ss(M,C)&&(U=ge(M),he(M,F,Y,!0),M=null),C.patchFlag===-2&&(oe=!1,C.dynamicChildren=null);const{type:ie,ref:Z,shapeFlag:w}=C;switch(ie){case cl:m(M,C,k,U);break;case Ln:h(M,C,k,U);break;case ga:M==null&&y(C,k,U,S);break;case Lt:N(M,C,k,U,F,Y,S,ae,oe);break;default:w&1?D(M,C,k,U,F,Y,S,ae,oe):w&6?V(M,C,k,U,F,Y,S,ae,oe):(w&64||w&128)&&ie.process(M,C,k,U,F,Y,S,ae,oe,re)}Z!=null&&F&&Uc(Z,M&&M.ref,Y,C||M,!C)},m=(M,C,k,U)=>{if(M==null)i(C.el=a(C.children),k,U);else{const F=C.el=M.el;C.children!==M.children&&c(F,C.children)}},h=(M,C,k,U)=>{M==null?i(C.el=l(C.children||""),k,U):C.el=M.el},y=(M,C,k,U)=>{[M.el,M.anchor]=_(M.children,C,k,U,M.el,M.anchor)},E=({el:M,anchor:C},k,U)=>{let F;for(;M&&M!==C;)F=d(M),i(M,k,U),M=F;i(C,k,U)},A=({el:M,anchor:C})=>{let k;for(;M&&M!==C;)k=d(M),s(M),M=k;s(C)},D=(M,C,k,U,F,Y,S,ae,oe)=>{C.type==="svg"?S="svg":C.type==="math"&&(S="mathml"),M==null?R(C,k,U,F,Y,S,ae,oe):T(M,C,F,Y,S,ae,oe)},R=(M,C,k,U,F,Y,S,ae)=>{let oe,ie;const{props:Z,shapeFlag:w,transition:g,dirs:L}=M;if(oe=M.el=o(M.type,Y,Z&&Z.is,Z),w&8?u(oe,M.children):w&16&&v(M.children,oe,null,U,F,Ll(M,Y),S,ae),L&&cs(M,null,U,"created"),I(oe,M,M.scopeId,S,U),Z){for(const K in Z)K!=="value"&&!jr(K)&&r(oe,K,null,Z[K],Y,M.children,U,F,se);"value"in Z&&r(oe,"value",null,Z.value,Y),(ie=Z.onVnodeBeforeMount)&&Wn(ie,U,M)}L&&cs(M,null,U,"beforeMount");const $=y0(F,g);$&&g.beforeEnter(oe),i(oe,C,k),((ie=Z&&Z.onVnodeMounted)||$||L)&&cn(()=>{ie&&Wn(ie,U,M),$&&g.enter(oe),L&&cs(M,null,U,"mounted")},F)},I=(M,C,k,U,F)=>{if(k&&p(M,k),U)for(let Y=0;Y<U.length;Y++)p(M,U[Y]);if(F){let Y=F.subTree;if(C===Y){const S=F.vnode;I(M,S,S.scopeId,S.slotScopeIds,F.parent)}}},v=(M,C,k,U,F,Y,S,ae,oe=0)=>{for(let ie=oe;ie<M.length;ie++){const Z=M[ie]=ae?Wi(M[ie]):Yn(M[ie]);x(null,Z,C,k,U,F,Y,S,ae)}},T=(M,C,k,U,F,Y,S)=>{const ae=C.el=M.el;let{patchFlag:oe,dynamicChildren:ie,dirs:Z}=C;oe|=M.patchFlag&16;const w=M.props||yt,g=C.props||yt;let L;if(k&&us(k,!1),(L=g.onVnodeBeforeUpdate)&&Wn(L,k,C,M),Z&&cs(C,M,k,"beforeUpdate"),k&&us(k,!0),ie?Q(M.dynamicChildren,ie,ae,k,U,Ll(C,F),Y):S||de(M,C,ae,null,k,U,Ll(C,F),Y,!1),oe>0){if(oe&16)P(ae,C,w,g,k,U,F);else if(oe&2&&w.class!==g.class&&r(ae,"class",null,g.class,F),oe&4&&r(ae,"style",w.style,g.style,F),oe&8){const $=C.dynamicProps;for(let K=0;K<$.length;K++){const q=$[K],be=w[q],pe=g[q];(pe!==be||q==="value")&&r(ae,q,be,pe,F,M.children,k,U,se)}}oe&1&&M.children!==C.children&&u(ae,C.children)}else!S&&ie==null&&P(ae,C,w,g,k,U,F);((L=g.onVnodeUpdated)||Z)&&cn(()=>{L&&Wn(L,k,C,M),Z&&cs(C,M,k,"updated")},U)},Q=(M,C,k,U,F,Y,S)=>{for(let ae=0;ae<C.length;ae++){const oe=M[ae],ie=C[ae],Z=oe.el&&(oe.type===Lt||!Ss(oe,ie)||oe.shapeFlag&70)?f(oe.el):k;x(oe,ie,Z,null,U,F,Y,S,!0)}},P=(M,C,k,U,F,Y,S)=>{if(k!==U){if(k!==yt)for(const ae in k)!jr(ae)&&!(ae in U)&&r(M,ae,k[ae],null,S,C.children,F,Y,se);for(const ae in U){if(jr(ae))continue;const oe=U[ae],ie=k[ae];oe!==ie&&ae!=="value"&&r(M,ae,ie,oe,S,C.children,F,Y,se)}"value"in U&&r(M,"value",k.value,U.value,S)}},N=(M,C,k,U,F,Y,S,ae,oe)=>{const ie=C.el=M?M.el:a(""),Z=C.anchor=M?M.anchor:a("");let{patchFlag:w,dynamicChildren:g,slotScopeIds:L}=C;L&&(ae=ae?ae.concat(L):L),M==null?(i(ie,k,U),i(Z,k,U),v(C.children||[],k,Z,F,Y,S,ae,oe)):w>0&&w&64&&g&&M.dynamicChildren?(Q(M.dynamicChildren,g,k,F,Y,S,ae),(C.key!=null||F&&C===F.subTree)&&zp(M,C,!0)):de(M,C,k,Z,F,Y,S,ae,oe)},V=(M,C,k,U,F,Y,S,ae,oe)=>{C.slotScopeIds=ae,M==null?C.shapeFlag&512?F.ctx.activate(C,k,U,S,oe):ee(C,k,U,F,Y,S,oe):X(M,C,oe)},ee=(M,C,k,U,F,Y,S)=>{const ae=M.component=L0(M,U,F);if(ol(M)&&(ae.ctx.renderer=re),I0(ae),ae.asyncDep){if(F&&F.registerDep(ae,G),!M.el){const oe=ae.subTree=st(Ln);h(null,oe,C,k)}}else G(ae,M,C,k,F,Y,S)},X=(M,C,k)=>{const U=C.component=M.component;if(B_(M,C,k))if(U.asyncDep&&!U.asyncResolved){O(U,C,k);return}else U.next=C,D_(U.update),U.effect.dirty=!0,U.update();else C.el=M.el,U.vnode=C},G=(M,C,k,U,F,Y,S)=>{const ae=()=>{if(M.isMounted){let{next:Z,bu:w,u:g,parent:L,vnode:$}=M;{const Pe=Vp(M);if(Pe){Z&&(Z.el=$.el,O(M,Z,S)),Pe.asyncDep.then(()=>{M.isUnmounted||ae()});return}}let K=Z,q;us(M,!1),Z?(Z.el=$.el,O(M,Z,S)):Z=$,w&&ha(w),(q=Z.props&&Z.props.onVnodeBeforeUpdate)&&Wn(q,L,Z,$),us(M,!0);const be=Yd(M),pe=M.subTree;M.subTree=be,x(pe,be,f(pe.el),ge(pe),M,F,Y),Z.el=be.el,K===null&&k_(M,be.el),g&&cn(g,F),(q=Z.props&&Z.props.onVnodeUpdated)&&cn(()=>Wn(q,L,Z,$),F)}else{let Z;const{el:w,props:g}=C,{bm:L,m:$,parent:K}=M,q=Kr(C);us(M,!1),L&&ha(L),!q&&(Z=g&&g.onVnodeBeforeMount)&&Wn(Z,K,C),us(M,!0);{const be=M.subTree=Yd(M);x(null,be,k,U,M,F,Y),C.el=be.el}if($&&cn($,F),!q&&(Z=g&&g.onVnodeMounted)){const be=C;cn(()=>Wn(Z,K,be),F)}(C.shapeFlag&256||K&&Kr(K.vnode)&&K.vnode.shapeFlag&256)&&M.a&&cn(M.a,F),M.isMounted=!0,C=k=U=null}},oe=M.effect=new Fu(ae,Rn,()=>$u(ie),M.scope),ie=M.update=()=>{oe.dirty&&oe.run()};ie.id=M.uid,us(M,!0),ie()},O=(M,C,k)=>{C.component=M;const U=M.vnode.props;M.vnode=C,M.next=null,g0(M,C.props,U,k),x0(M,C.children,k),Ns(),qd(M),Fs()},de=(M,C,k,U,F,Y,S,ae,oe=!1)=>{const ie=M&&M.children,Z=M?M.shapeFlag:0,w=C.children,{patchFlag:g,shapeFlag:L}=C;if(g>0){if(g&128){ye(ie,w,k,U,F,Y,S,ae,oe);return}else if(g&256){fe(ie,w,k,U,F,Y,S,ae,oe);return}}L&8?(Z&16&&se(ie,F,Y),w!==ie&&u(k,w)):Z&16?L&16?ye(ie,w,k,U,F,Y,S,ae,oe):se(ie,F,Y,!0):(Z&8&&u(k,""),L&16&&v(w,k,U,F,Y,S,ae,oe))},fe=(M,C,k,U,F,Y,S,ae,oe)=>{M=M||rr,C=C||rr;const ie=M.length,Z=C.length,w=Math.min(ie,Z);let g;for(g=0;g<w;g++){const L=C[g]=oe?Wi(C[g]):Yn(C[g]);x(M[g],L,k,null,F,Y,S,ae,oe)}ie>Z?se(M,F,Y,!0,!1,w):v(C,k,U,F,Y,S,ae,oe,w)},ye=(M,C,k,U,F,Y,S,ae,oe)=>{let ie=0;const Z=C.length;let w=M.length-1,g=Z-1;for(;ie<=w&&ie<=g;){const L=M[ie],$=C[ie]=oe?Wi(C[ie]):Yn(C[ie]);if(Ss(L,$))x(L,$,k,null,F,Y,S,ae,oe);else break;ie++}for(;ie<=w&&ie<=g;){const L=M[w],$=C[g]=oe?Wi(C[g]):Yn(C[g]);if(Ss(L,$))x(L,$,k,null,F,Y,S,ae,oe);else break;w--,g--}if(ie>w){if(ie<=g){const L=g+1,$=L<Z?C[L].el:U;for(;ie<=g;)x(null,C[ie]=oe?Wi(C[ie]):Yn(C[ie]),k,$,F,Y,S,ae,oe),ie++}}else if(ie>g)for(;ie<=w;)he(M[ie],F,Y,!0),ie++;else{const L=ie,$=ie,K=new Map;for(ie=$;ie<=g;ie++){const Me=C[ie]=oe?Wi(C[ie]):Yn(C[ie]);Me.key!=null&&K.set(Me.key,ie)}let q,be=0;const pe=g-$+1;let Pe=!1,ze=0;const me=new Array(pe);for(ie=0;ie<pe;ie++)me[ie]=0;for(ie=L;ie<=w;ie++){const Me=M[ie];if(be>=pe){he(Me,F,Y,!0);continue}let Ce;if(Me.key!=null)Ce=K.get(Me.key);else for(q=$;q<=g;q++)if(me[q-$]===0&&Ss(Me,C[q])){Ce=q;break}Ce===void 0?he(Me,F,Y,!0):(me[Ce-$]=ie+1,Ce>=ze?ze=Ce:Pe=!0,x(Me,C[Ce],k,null,F,Y,S,ae,oe),be++)}const xe=Pe?S0(me):rr;for(q=xe.length-1,ie=pe-1;ie>=0;ie--){const Me=$+ie,Ce=C[Me],Re=Me+1<Z?C[Me+1].el:U;me[ie]===0?x(null,Ce,k,Re,F,Y,S,ae,oe):Pe&&(q<0||ie!==xe[q]?ue(Ce,k,Re,2):q--)}}},ue=(M,C,k,U,F=null)=>{const{el:Y,type:S,transition:ae,children:oe,shapeFlag:ie}=M;if(ie&6){ue(M.component.subTree,C,k,U);return}if(ie&128){M.suspense.move(C,k,U);return}if(ie&64){S.move(M,C,k,re);return}if(S===Lt){i(Y,C,k);for(let w=0;w<oe.length;w++)ue(oe[w],C,k,U);i(M.anchor,C,k);return}if(S===ga){E(M,C,k);return}if(U!==2&&ie&1&&ae)if(U===0)ae.beforeEnter(Y),i(Y,C,k),cn(()=>ae.enter(Y),F);else{const{leave:w,delayLeave:g,afterLeave:L}=ae,$=()=>i(Y,C,k),K=()=>{w(Y,()=>{$(),L&&L()})};g?g(Y,$,K):K()}else i(Y,C,k)},he=(M,C,k,U=!1,F=!1)=>{const{type:Y,props:S,ref:ae,children:oe,dynamicChildren:ie,shapeFlag:Z,patchFlag:w,dirs:g}=M;if(ae!=null&&Uc(ae,null,k,M,!0),Z&256){C.ctx.deactivate(M);return}const L=Z&1&&g,$=!Kr(M);let K;if($&&(K=S&&S.onVnodeBeforeUnmount)&&Wn(K,C,M),Z&6)it(M.component,k,U);else{if(Z&128){M.suspense.unmount(k,U);return}L&&cs(M,null,C,"beforeUnmount"),Z&64?M.type.remove(M,C,k,F,re,U):ie&&(Y!==Lt||w>0&&w&64)?se(ie,C,k,!1,!0):(Y===Lt&&w&384||!F&&Z&16)&&se(oe,C,k),U&&Fe(M)}($&&(K=S&&S.onVnodeUnmounted)||L)&&cn(()=>{K&&Wn(K,C,M),L&&cs(M,null,C,"unmounted")},k)},Fe=M=>{const{type:C,el:k,anchor:U,transition:F}=M;if(C===Lt){at(k,U);return}if(C===ga){A(M);return}const Y=()=>{s(k),F&&!F.persisted&&F.afterLeave&&F.afterLeave()};if(M.shapeFlag&1&&F&&!F.persisted){const{leave:S,delayLeave:ae}=F,oe=()=>S(k,Y);ae?ae(M.el,Y,oe):oe()}else Y()},at=(M,C)=>{let k;for(;M!==C;)k=d(M),s(M),M=k;s(C)},it=(M,C,k)=>{const{bum:U,scope:F,update:Y,subTree:S,um:ae}=M;U&&ha(U),F.stop(),Y&&(Y.active=!1,he(S,M,C,k)),ae&&cn(ae,C),cn(()=>{M.isUnmounted=!0},C),C&&C.pendingBranch&&!C.isUnmounted&&M.asyncDep&&!M.asyncResolved&&M.suspenseId===C.pendingId&&(C.deps--,C.deps===0&&C.resolve())},se=(M,C,k,U=!1,F=!1,Y=0)=>{for(let S=Y;S<M.length;S++)he(M[S],C,k,U,F)},ge=M=>M.shapeFlag&6?ge(M.component.subTree):M.shapeFlag&128?M.suspense.next():d(M.anchor||M.el);let ve=!1;const He=(M,C,k)=>{M==null?C._vnode&&he(C._vnode,null,null,!0):x(C._vnode||null,M,C,null,null,null,k),ve||(ve=!0,qd(),yp(),ve=!1),C._vnode=M},re={p:x,um:he,m:ue,r:Fe,mt:ee,mc:v,pc:de,pbc:Q,n:ge,o:t};return{render:He,hydrate:void 0,createApp:h0(He)}}function Ll({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function us({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function y0(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function zp(t,e,n=!1){const i=t.children,s=e.children;if(Ve(i)&&Ve(s))for(let r=0;r<i.length;r++){const o=i[r];let a=s[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[r]=Wi(s[r]),a.el=o.el),n||zp(o,a)),a.type===cl&&(a.el=o.el)}}function S0(t){const e=t.slice(),n=[0];let i,s,r,o,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(s=n[n.length-1],t[s]<c){e[i]=s,n.push(i);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<c?r=a+1:o=a;c<t[n[r]]&&(r>0&&(e[i]=n[r-1]),n[r]=i)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}function Vp(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Vp(e)}const M0=t=>t.__isTeleport,Lt=Symbol.for("v-fgt"),cl=Symbol.for("v-txt"),Ln=Symbol.for("v-cmt"),ga=Symbol.for("v-stc"),Qr=[];let kn=null;function $e(t=!1){Qr.push(kn=t?null:[])}function E0(){Qr.pop(),kn=Qr[Qr.length-1]||null}let ro=1;function of(t){ro+=t}function Hp(t){return t.dynamicChildren=ro>0?kn||rr:null,E0(),ro>0&&kn&&kn.push(t),t}function qe(t,e,n,i,s,r){return Hp(z(t,e,n,i,s,r,!0))}function Gp(t,e,n,i,s){return Hp(st(t,e,n,i,s,!0))}function Da(t){return t?t.__v_isVNode===!0:!1}function Ss(t,e){return t.type===e.type&&t.key===e.key}const ul="__vInternal",Wp=({key:t})=>t??null,_a=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Ut(t)||pn(t)||Ze(t)?{i:zt,r:t,k:e,f:!!n}:t:null);function z(t,e=null,n=null,i=0,s=null,r=t===Lt?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Wp(e),ref:e&&_a(e),scopeId:rl,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:zt};return a?(Yu(l,n),r&128&&t.normalize(l)):n&&(l.shapeFlag|=Ut(n)?8:16),ro>0&&!o&&kn&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&kn.push(l),l}const st=T0;function T0(t,e=null,n=null,i=0,s=null,r=!1){if((!t||t===z_)&&(t=Ln),Da(t)){const a=ss(t,e,!0);return n&&Yu(a,n),ro>0&&!r&&kn&&(a.shapeFlag&6?kn[kn.indexOf(t)]=a:kn.push(a)),a.patchFlag|=-2,a}if(O0(t)&&(t=t.__vccOpts),e){e=A0(e);let{class:a,style:l}=e;a&&!Ut(a)&&(e.class=It(a)),xt(l)&&(gp(l)&&!Ve(l)&&(l=Qt({},l)),e.style=_i(l))}const o=Ut(t)?1:V_(t)?128:M0(t)?64:xt(t)?4:Ze(t)?2:0;return z(t,e,n,i,s,o,r,!0)}function A0(t){return t?gp(t)||ul in t?Qt({},t):t:null}function ss(t,e,n=!1){const{props:i,ref:s,patchFlag:r,children:o}=t,a=e?C0(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Wp(a),ref:e&&e.ref?n&&s?Ve(s)?s.concat(_a(e)):[s,_a(e)]:_a(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Lt?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&ss(t.ssContent),ssFallback:t.ssFallback&&ss(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function Mi(t=" ",e=0){return st(cl,null,t,e)}function $p(t,e){const n=st(ga,null,t);return n.staticCount=e,n}function Dt(t="",e=!1){return e?($e(),Gp(Ln,null,t)):st(Ln,null,t)}function Yn(t){return t==null||typeof t=="boolean"?st(Ln):Ve(t)?st(Lt,null,t.slice()):typeof t=="object"?Wi(t):st(cl,null,String(t))}function Wi(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:ss(t)}function Yu(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(Ve(e))n=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),Yu(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(ul in e)?e._ctx=zt:s===3&&zt&&(zt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else Ze(e)?(e={default:e,_ctx:zt},n=32):(e=String(e),i&64?(n=16,e=[Mi(e)]):n=8);t.children=e,t.shapeFlag|=n}function C0(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=It([e.class,i.class]));else if(s==="style")e.style=_i([e.style,i.style]);else if(Za(s)){const r=e[s],o=i[s];o&&r!==o&&!(Ve(r)&&r.includes(o))&&(e[s]=r?[].concat(r,o):o)}else s!==""&&(e[s]=i[s])}return e}function Wn(t,e,n,i=null){Pn(t,e,7,[n,i])}const R0=Up();let P0=0;function L0(t,e,n){const i=t.type,s=(e?e.appContext:t.appContext)||R0,r={uid:P0++,vnode:t,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new ip(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Fp(i,s),emitsOptions:Mp(i,s),emit:null,emitted:null,propsDefaults:yt,inheritAttrs:i.inheritAttrs,ctx:yt,data:yt,props:yt,attrs:yt,slots:yt,refs:yt,setupState:yt,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=N_.bind(null,r),t.ce&&t.ce(r),r}let Kt=null;const D0=()=>Kt||zt;let Ia,Nc;{const t=ep(),e=(n,i)=>{let s;return(s=t[n])||(s=t[n]=[]),s.push(i),r=>{s.length>1?s.forEach(o=>o(r)):s[0](r)}};Ia=e("__VUE_INSTANCE_SETTERS__",n=>Kt=n),Nc=e("__VUE_SSR_SETTERS__",n=>dl=n)}const _o=t=>{const e=Kt;return Ia(t),t.scope.on(),()=>{t.scope.off(),Ia(e)}},af=()=>{Kt&&Kt.scope.off(),Ia(null)};function Xp(t){return t.vnode.shapeFlag&4}let dl=!1;function I0(t,e=!1){e&&Nc(e);const{props:n,children:i}=t.vnode,s=Xp(t);m0(t,n,s,e),v0(t,i);const r=s?U0(t,e):void 0;return e&&Nc(!1),r}function U0(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Hu(new Proxy(t.ctx,o0));const{setup:i}=n;if(i){const s=t.setupContext=i.length>1?F0(t):null,r=_o(t);Ns();const o=es(i,t,0,[t.props,s]);if(Fs(),r(),Kh(o)){if(o.then(af,af),e)return o.then(a=>{lf(t,a)}).catch(a=>{il(a,t,0)});t.asyncDep=o}else lf(t,o)}else qp(t)}function lf(t,e,n){Ze(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:xt(e)&&(t.setupState=xp(e)),qp(t)}function qp(t,e,n){const i=t.type;t.render||(t.render=i.render||Rn);{const s=_o(t);Ns();try{a0(t)}finally{Fs(),s()}}}function N0(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return hn(t,"get","$attrs"),e[n]}}))}function F0(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return N0(t)},slots:t.slots,emit:t.emit,expose:e}}function fl(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(xp(Hu(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Zr)return Zr[n](t)},has(e,n){return n in e||n in Zr}}))}function O0(t){return Ze(t)&&"__vccOpts"in t}const Ct=(t,e)=>T_(t,e,dl);function B0(t,e,n){const i=arguments.length;return i===2?xt(e)&&!Ve(e)?Da(e)?st(t,null,[e]):st(t,e):st(t,null,e):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&Da(n)&&(n=[n]),st(t,e,n))}const k0="3.4.21";/**
* @vue/runtime-dom v3.4.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const z0="http://www.w3.org/2000/svg",V0="http://www.w3.org/1998/Math/MathML",$i=typeof document<"u"?document:null,cf=$i&&$i.createElement("template"),H0={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const s=e==="svg"?$i.createElementNS(z0,t):e==="mathml"?$i.createElementNS(V0,t):$i.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:t=>$i.createTextNode(t),createComment:t=>$i.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>$i.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,s,r){const o=n?n.previousSibling:e.lastChild;if(s&&(s===r||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===r||!(s=s.nextSibling)););else{cf.innerHTML=i==="svg"?`<svg>${t}</svg>`:i==="mathml"?`<math>${t}</math>`:t;const a=cf.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},Ii="transition",Dr="animation",oo=Symbol("_vtc"),ts=(t,{slots:e})=>B0(Y_,G0(t),e);ts.displayName="Transition";const Yp={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};ts.props=Qt({},Ap,Yp);const ds=(t,e=[])=>{Ve(t)?t.forEach(n=>n(...e)):t&&t(...e)},uf=t=>t?Ve(t)?t.some(e=>e.length>1):t.length>1:!1;function G0(t){const e={};for(const N in t)N in Yp||(e[N]=t[N]);if(t.css===!1)return e;const{name:n="v",type:i,duration:s,enterFromClass:r=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:l=r,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:f=`${n}-leave-from`,leaveActiveClass:d=`${n}-leave-active`,leaveToClass:p=`${n}-leave-to`}=t,_=W0(s),x=_&&_[0],m=_&&_[1],{onBeforeEnter:h,onEnter:y,onEnterCancelled:E,onLeave:A,onLeaveCancelled:D,onBeforeAppear:R=h,onAppear:I=y,onAppearCancelled:v=E}=e,T=(N,V,ee)=>{fs(N,V?u:a),fs(N,V?c:o),ee&&ee()},Q=(N,V)=>{N._isLeaving=!1,fs(N,f),fs(N,p),fs(N,d),V&&V()},P=N=>(V,ee)=>{const X=N?I:y,G=()=>T(V,N,ee);ds(X,[V,G]),df(()=>{fs(V,N?l:r),Ui(V,N?u:a),uf(X)||ff(V,i,x,G)})};return Qt(e,{onBeforeEnter(N){ds(h,[N]),Ui(N,r),Ui(N,o)},onBeforeAppear(N){ds(R,[N]),Ui(N,l),Ui(N,c)},onEnter:P(!1),onAppear:P(!0),onLeave(N,V){N._isLeaving=!0;const ee=()=>Q(N,V);Ui(N,f),q0(),Ui(N,d),df(()=>{N._isLeaving&&(fs(N,f),Ui(N,p),uf(A)||ff(N,i,m,ee))}),ds(A,[N,ee])},onEnterCancelled(N){T(N,!1),ds(E,[N])},onAppearCancelled(N){T(N,!0),ds(v,[N])},onLeaveCancelled(N){Q(N),ds(D,[N])}})}function W0(t){if(t==null)return null;if(xt(t))return[Dl(t.enter),Dl(t.leave)];{const e=Dl(t);return[e,e]}}function Dl(t){return Yg(t)}function Ui(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t[oo]||(t[oo]=new Set)).add(e)}function fs(t,e){e.split(/\s+/).forEach(i=>i&&t.classList.remove(i));const n=t[oo];n&&(n.delete(e),n.size||(t[oo]=void 0))}function df(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let $0=0;function ff(t,e,n,i){const s=t._endId=++$0,r=()=>{s===t._endId&&i()};if(n)return setTimeout(r,n);const{type:o,timeout:a,propCount:l}=X0(t,e);if(!o)return i();const c=o+"end";let u=0;const f=()=>{t.removeEventListener(c,d),r()},d=p=>{p.target===t&&++u>=l&&f()};setTimeout(()=>{u<l&&f()},a+1),t.addEventListener(c,d)}function X0(t,e){const n=window.getComputedStyle(t),i=_=>(n[_]||"").split(", "),s=i(`${Ii}Delay`),r=i(`${Ii}Duration`),o=hf(s,r),a=i(`${Dr}Delay`),l=i(`${Dr}Duration`),c=hf(a,l);let u=null,f=0,d=0;e===Ii?o>0&&(u=Ii,f=o,d=r.length):e===Dr?c>0&&(u=Dr,f=c,d=l.length):(f=Math.max(o,c),u=f>0?o>c?Ii:Dr:null,d=u?u===Ii?r.length:l.length:0);const p=u===Ii&&/\b(transform|all)(,|$)/.test(i(`${Ii}Property`).toString());return{type:u,timeout:f,propCount:d,hasTransform:p}}function hf(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,i)=>pf(n)+pf(t[i])))}function pf(t){return t==="auto"?0:Number(t.slice(0,-1).replace(",","."))*1e3}function q0(){return document.body.offsetHeight}function Y0(t,e,n){const i=t[oo];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const Ua=Symbol("_vod"),jp=Symbol("_vsh"),j0={beforeMount(t,{value:e},{transition:n}){t[Ua]=t.style.display==="none"?"":t.style.display,n&&e?n.beforeEnter(t):Ir(t,e)},mounted(t,{value:e},{transition:n}){n&&e&&n.enter(t)},updated(t,{value:e,oldValue:n},{transition:i}){!e!=!n&&(i?e?(i.beforeEnter(t),Ir(t,!0),i.enter(t)):i.leave(t,()=>{Ir(t,!1)}):Ir(t,e))},beforeUnmount(t,{value:e}){Ir(t,e)}};function Ir(t,e){t.style.display=e?t[Ua]:"none",t[jp]=!e}const K0=Symbol(""),Z0=/(^|;)\s*display\s*:/;function J0(t,e,n){const i=t.style,s=Ut(n);let r=!1;if(n&&!s){if(e)if(Ut(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();n[a]==null&&va(i,a,"")}else for(const o in e)n[o]==null&&va(i,o,"");for(const o in n)o==="display"&&(r=!0),va(i,o,n[o])}else if(s){if(e!==n){const o=i[K0];o&&(n+=";"+o),i.cssText=n,r=Z0.test(n)}}else e&&t.removeAttribute("style");Ua in t&&(t[Ua]=r?i.display:"",t[jp]&&(i.display="none"))}const mf=/\s*!important$/;function va(t,e,n){if(Ve(n))n.forEach(i=>va(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=Q0(t,e);mf.test(n)?t.setProperty(Sr(i),n.replace(mf,""),"important"):t[i]=n}}const gf=["Webkit","Moz","ms"],Il={};function Q0(t,e){const n=Il[e];if(n)return n;let i=pr(e);if(i!=="filter"&&i in t)return Il[e]=i;i=Qh(i);for(let s=0;s<gf.length;s++){const r=gf[s]+i;if(r in t)return Il[e]=r}return e}const _f="http://www.w3.org/1999/xlink";function ev(t,e,n,i,s){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(_f,e.slice(6,e.length)):t.setAttributeNS(_f,e,n);else{const r=e_(e);n==null||r&&!tp(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function tv(t,e,n,i,s,r,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,s,r),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){const c=a==="OPTION"?t.getAttribute("value")||"":t.value,u=n??"";(c!==u||!("_value"in t))&&(t.value=u),n==null&&t.removeAttribute(e),t._value=n;return}let l=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=tp(n):n==null&&c==="string"?(n="",l=!0):c==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}function Ms(t,e,n,i){t.addEventListener(e,n,i)}function nv(t,e,n,i){t.removeEventListener(e,n,i)}const vf=Symbol("_vei");function iv(t,e,n,i,s=null){const r=t[vf]||(t[vf]={}),o=r[e];if(i&&o)o.value=i;else{const[a,l]=sv(e);if(i){const c=r[e]=av(i,s);Ms(t,a,c,l)}else o&&(nv(t,a,o,l),r[e]=void 0)}}const xf=/(?:Once|Passive|Capture)$/;function sv(t){let e;if(xf.test(t)){e={};let i;for(;i=t.match(xf);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Sr(t.slice(2)),e]}let Ul=0;const rv=Promise.resolve(),ov=()=>Ul||(rv.then(()=>Ul=0),Ul=Date.now());function av(t,e){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;Pn(lv(i,n.value),e,5,[i])};return n.value=t,n.attached=ov(),n}function lv(t,e){if(Ve(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const bf=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,cv=(t,e,n,i,s,r,o,a,l)=>{const c=s==="svg";e==="class"?Y0(t,i,c):e==="style"?J0(t,n,i):Za(e)?Iu(e)||iv(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):uv(t,e,i,c))?tv(t,e,i,r,o,a,l):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),ev(t,e,i,c))};function uv(t,e,n,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in t&&bf(e)&&Ze(n));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const s=t.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return bf(e)&&Ut(n)?!1:e in t}const Na=t=>{const e=t.props["onUpdate:modelValue"]||!1;return Ve(e)?n=>ha(e,n):e};function dv(t){t.target.composing=!0}function wf(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const cr=Symbol("_assign"),Nl={created(t,{modifiers:{lazy:e,trim:n,number:i}},s){t[cr]=Na(s);const r=i||s.props&&s.props.type==="number";Ms(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),r&&(a=to(a)),t[cr](a)}),n&&Ms(t,"change",()=>{t.value=t.value.trim()}),e||(Ms(t,"compositionstart",dv),Ms(t,"compositionend",wf),Ms(t,"change",wf))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:i,number:s}},r){if(t[cr]=Na(r),t.composing)return;const o=s||t.type==="number"?to(t.value):t.value,a=e??"";o!==a&&(document.activeElement===t&&t.type!=="range"&&(n||i&&t.value.trim()===a)||(t.value=a))}},fv={deep:!0,created(t,{value:e,modifiers:{number:n}},i){const s=Ja(e);Ms(t,"change",()=>{const r=Array.prototype.filter.call(t.options,o=>o.selected).map(o=>n?to(Fa(o)):Fa(o));t[cr](t.multiple?s?new Set(r):r:r[0]),t._assigning=!0,Ra(()=>{t._assigning=!1})}),t[cr]=Na(i)},mounted(t,{value:e,modifiers:{number:n}}){yf(t,e,n)},beforeUpdate(t,e,n){t[cr]=Na(n)},updated(t,{value:e,modifiers:{number:n}}){t._assigning||yf(t,e,n)}};function yf(t,e,n){const i=t.multiple,s=Ve(e);if(!(i&&!s&&!Ja(e))){for(let r=0,o=t.options.length;r<o;r++){const a=t.options[r],l=Fa(a);if(i)if(s){const c=typeof l;c==="string"||c==="number"?a.selected=e.includes(n?to(l):l):a.selected=n_(e,l)>-1}else a.selected=e.has(l);else if(el(Fa(a),e)){t.selectedIndex!==r&&(t.selectedIndex=r);return}}!i&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function Fa(t){return"_value"in t?t._value:t.value}const hv=["ctrl","shift","alt","meta"],pv={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>hv.some(n=>t[`${n}Key`]&&!e.includes(n))},mv=(t,e)=>{const n=t._withMods||(t._withMods={}),i=e.join(".");return n[i]||(n[i]=(s,...r)=>{for(let o=0;o<e.length;o++){const a=pv[e[o]];if(a&&a(s,e))return}return t(s,...r)})},gv=Qt({patchProp:cv},H0);let Sf;function _v(){return Sf||(Sf=b0(gv))}const vv=(...t)=>{const e=_v().createApp(...t),{mount:n}=e;return e.mount=i=>{const s=bv(i);if(!s)return;const r=e._component;!Ze(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,xv(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function xv(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function bv(t){return Ut(t)?document.querySelector(t):t}/*!
 * pinia v2.1.7
 * (c) 2023 Eduardo San Martin Morote
 * @license MIT
 */const wv=Symbol();var Mf;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Mf||(Mf={}));function yv(){const t=i_(!0),e=t.run(()=>et({}));let n=[],i=[];const s=Hu({install(r){s._a=r,r.provide(wv,s),r.config.globalProperties.$pinia=s,i.forEach(o=>n.push(o)),i=[]},use(r){return this._a?n.push(r):i.push(r),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const Sv="/luftqi/assets/LOGO_450x450_01.png",li=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},Mv={class:"section-title"},Ev={class:"section-body"},Tv={__name:"SidebarSection",props:{title:{type:String,required:!0},icon:{type:String,default:"fas fa-circle"},defaultOpen:{type:Boolean,default:!0}},setup(t){const n=et(t.defaultOpen),i=()=>{n.value=!n.value};return(s,r)=>($e(),qe("div",{class:It(["section",{collapsed:!n.value}])},[z("button",{class:It(["section-header",n.value?"section-header-close":"section-header-open"]),onClick:i},[z("div",Mv,[z("i",{class:It(t.icon)},null,2),z("span",null,un(t.title),1)]),z("i",{class:It(["toggle-icon fas",n.value?"fa-chevron-up":"fa-chevron-down"])},null,2)],2),st(ts,{name:"collapse"},{default:Cn(()=>[$r(z("div",Ev,[r0(s.$slots,"default",{},void 0,!0)],512),[[j0,n.value]])]),_:3})],2))}},Ur=li(Tv,[["__scopeId","data-v-2d285c84"]]);/*!
* sweetalert2 v11.26.18
* Released under the MIT License.
*/function Kp(t,e,n){if(typeof t=="function"?t===e:t.has(e))return arguments.length<3?e:n;throw new TypeError("Private element is not present on this object")}function Av(t,e){if(e.has(t))throw new TypeError("Cannot initialize the same private elements twice on an object")}function Ef(t,e){return t.get(Kp(t,e))}function Cv(t,e,n){Av(t,e),e.set(t,n)}function Rv(t,e,n){return t.set(Kp(t,e),n),n}const Pv=100,Oe={},Lv=()=>{Oe.previousActiveElement instanceof HTMLElement?(Oe.previousActiveElement.focus(),Oe.previousActiveElement=null):document.body&&document.body.focus()},Dv=t=>new Promise(e=>{if(!t)return e();const n=window.scrollX,i=window.scrollY;Oe.restoreFocusTimeout=setTimeout(()=>{Lv(),e()},Pv),window.scrollTo(n,i)}),Zp="swal2-",Iv=["container","shown","height-auto","iosfix","popup","modal","no-backdrop","no-transition","toast","toast-shown","show","hide","close","title","html-container","actions","confirm","deny","cancel","footer","icon","icon-content","image","input","file","range","select","radio","checkbox","label","textarea","inputerror","input-label","validation-message","progress-steps","active-progress-step","progress-step","progress-step-line","loader","loading","styled","top","top-start","top-end","top-left","top-right","center","center-start","center-end","center-left","center-right","bottom","bottom-start","bottom-end","bottom-left","bottom-right","grow-row","grow-column","grow-fullscreen","rtl","timer-progress-bar","timer-progress-bar-container","scrollbar-measure","icon-success","icon-warning","icon-info","icon-question","icon-error","draggable","dragging"],le=Iv.reduce((t,e)=>(t[e]=Zp+e,t),{}),Uv=["success","warning","info","question","error"],Oa=Uv.reduce((t,e)=>(t[e]=Zp+e,t),{}),Jp="SweetAlert2:",ju=t=>t.charAt(0).toUpperCase()+t.slice(1),sn=t=>{console.warn(`${Jp} ${typeof t=="object"?t.join(" "):t}`)},Os=t=>{console.error(`${Jp} ${t}`)},Tf=[],Nv=t=>{Tf.includes(t)||(Tf.push(t),sn(t))},Qp=(t,e=null)=>{Nv(`"${t}" is deprecated and will be removed in the next major release.${e?` Use "${e}" instead.`:""}`)},hl=t=>typeof t=="function"?t():t,Ku=t=>t&&typeof t.toPromise=="function",vo=t=>Ku(t)?t.toPromise():Promise.resolve(t),Zu=t=>t&&Promise.resolve(t)===t,rn=()=>document.body.querySelector(`.${le.container}`),xo=t=>{const e=rn();return e?e.querySelector(t):null},yn=t=>xo(`.${t}`),ft=()=>yn(le.popup),Mr=()=>yn(le.icon),Fv=()=>yn(le["icon-content"]),em=()=>yn(le.title),Ju=()=>yn(le["html-container"]),tm=()=>yn(le.image),Qu=()=>yn(le["progress-steps"]),pl=()=>yn(le["validation-message"]),ii=()=>xo(`.${le.actions} .${le.confirm}`),Er=()=>xo(`.${le.actions} .${le.cancel}`),Bs=()=>xo(`.${le.actions} .${le.deny}`),Ov=()=>yn(le["input-label"]),Tr=()=>xo(`.${le.loader}`),bo=()=>yn(le.actions),nm=()=>yn(le.footer),ml=()=>yn(le["timer-progress-bar"]),ed=()=>yn(le.close),Bv=`
  a[href],
  area[href],
  input:not([disabled]),
  select:not([disabled]),
  ...
  video[controls],
  summary
`,td=()=>{const t=ft();if(!t)return[];const e=t.querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),n=Array.from(e).sort((r,o)=>{const a=parseInt(r.getAttribute("tabindex")||"0"),l=parseInt(o.getAttribute("tabindex")||"0");return a>l?1:a<l?-1:0}),i=t.querySelectorAll(Bv),s=Array.from(i).filter(r=>r.getAttribute("tabindex")!=="-1");return[...new Set(n.concat(s))].filter(r=>dn(r))},nd=()=>wi(document.body,le.shown)&&!wi(document.body,le["toast-shown"])&&!wi(document.body,le["no-backdrop"]),gl=()=>{const t=ft();return t?wi(t,le.toast):!1},kv=()=>{const t=ft();return t?t.hasAttribute("data-loading"):!1},Sn=(t,e)=>{if(t.textContent="",e){const i=new DOMParser().parseFromString(e,"text/html"),s=i.querySelector("head");s&&Array.from(s.childNodes).forEach(o=>{t.appendChild(o)});const r=i.querySelector("body");r&&Array.from(r.childNodes).forEach(o=>{o instanceof HTMLVideoElement||o instanceof HTMLAudioElement?t.appendChild(o.cloneNode(!0)):t.appendChild(o)})}},wi=(t,e)=>{if(!e)return!1;const n=e.split(/\s+/);for(let i=0;i<n.length;i++)if(!t.classList.contains(n[i]))return!1;return!0},zv=(t,e)=>{Array.from(t.classList).forEach(n=>{!Object.values(le).includes(n)&&!Object.values(Oa).includes(n)&&!Object.values(e.showClass||{}).includes(n)&&t.classList.remove(n)})},wn=(t,e,n)=>{if(zv(t,e),!e.customClass)return;const i=e.customClass[n];if(i){if(typeof i!="string"&&!i.forEach){sn(`Invalid type of customClass.${n}! Expected string or iterable object, got "${typeof i}"`);return}dt(t,i)}},_l=(t,e)=>{if(!e)return null;switch(e){case"select":case"textarea":case"file":return t.querySelector(`.${le.popup} > .${le[e]}`);case"checkbox":return t.querySelector(`.${le.popup} > .${le.checkbox} input`);case"radio":return t.querySelector(`.${le.popup} > .${le.radio} input:checked`)||t.querySelector(`.${le.popup} > .${le.radio} input:first-child`);case"range":return t.querySelector(`.${le.popup} > .${le.range} input`);default:return t.querySelector(`.${le.popup} > .${le.input}`)}},im=t=>{if(t.focus(),t.type!=="file"){const e=t.value;t.value="",t.value=e}},sm=(t,e,n)=>{!t||!e||(typeof e=="string"&&(e=e.split(/\s+/).filter(Boolean)),e.forEach(i=>{Array.isArray(t)?t.forEach(s=>{n?s.classList.add(i):s.classList.remove(i)}):n?t.classList.add(i):t.classList.remove(i)}))},dt=(t,e)=>{sm(t,e,!0)},Dn=(t,e)=>{sm(t,e,!1)},Yi=(t,e)=>{const n=Array.from(t.children);for(let i=0;i<n.length;i++){const s=n[i];if(s instanceof HTMLElement&&wi(s,e))return s}},Ds=(t,e,n)=>{n===`${parseInt(`${n}`)}`&&(n=parseInt(n)),n||parseInt(`${n}`)===0?t.style.setProperty(e,typeof n=="number"?`${n}px`:n):t.style.removeProperty(e)},Vt=(t,e="flex")=>{t&&(t.style.display=e)},en=t=>{t&&(t.style.display="none")},id=(t,e="block")=>{t&&new MutationObserver(()=>{wo(t,t.innerHTML,e)}).observe(t,{childList:!0,subtree:!0})},Af=(t,e,n,i)=>{const s=t.querySelector(e);s&&s.style.setProperty(n,i)},wo=(t,e,n="flex")=>{e?Vt(t,n):en(t)},dn=t=>!!(t&&(t.offsetWidth||t.offsetHeight||t.getClientRects().length)),Vv=()=>!dn(ii())&&!dn(Bs())&&!dn(Er()),Fc=t=>t.scrollHeight>t.clientHeight,Hv=(t,e)=>{let n=t;for(;n&&n!==e;){if(Fc(n))return!0;n=n.parentElement}return!1},rm=t=>{const e=window.getComputedStyle(t),n=parseFloat(e.getPropertyValue("animation-duration")||"0"),i=parseFloat(e.getPropertyValue("transition-duration")||"0");return n>0||i>0},sd=(t,e=!1)=>{const n=ml();n&&dn(n)&&(e&&(n.style.transition="none",n.style.width="100%"),setTimeout(()=>{n.style.transition=`width ${t/1e3}s linear`,n.style.width="0%"},10))},Gv=()=>{const t=ml();if(!t)return;const e=parseInt(window.getComputedStyle(t).width);t.style.removeProperty("transition"),t.style.width="100%";const n=parseInt(window.getComputedStyle(t).width),i=e/n*100;t.style.width=`${i}%`},Wv=()=>typeof window>"u"||typeof document>"u",$v=`
...
`.replace(/(^|\n)\s*/g,""),Xv=()=>{const t=rn();return t?(t.remove(),Dn([document.documentElement,document.body],[le["no-backdrop"],le["toast-shown"],le["has-column"]]),!0):!1},hs=()=>{Oe.currentInstance&&Oe.currentInstance.resetValidationMessage()},qv=()=>{const t=ft();if(!t)return;const e=Yi(t,le.input),n=Yi(t,le.file),i=t.querySelector(`.${le.range} input`),s=t.querySelector(`.${le.range} output`),r=Yi(t,le.select),o=t.querySelector(`.${le.checkbox} input`),a=Yi(t,le.textarea);e&&(e.oninput=hs),n&&(n.onchange=hs),r&&(r.onchange=hs),o&&(o.onchange=hs),a&&(a.oninput=hs),i&&s&&(i.oninput=()=>{hs(),s.value=i.value},i.onchange=()=>{hs(),s.value=i.value})},Yv=t=>{if(typeof t=="string"){const e=document.querySelector(t);if(!e)throw new Error(`Target element "${t}" not found`);return e}return t},jv=t=>{const e=ft();e&&(e.setAttribute("role",t.toast?"alert":"dialog"),e.setAttribute("aria-live",t.toast?"polite":"assertive"),t.toast||e.setAttribute("aria-modal","true"))},Kv=t=>{window.getComputedStyle(t).direction==="rtl"&&(dt(rn(),le.rtl),Oe.isRTL=!0)},Zv=t=>{const e=Xv();if(Wv()){Os("SweetAlert2 requires document to initialize");return}const n=document.createElement("div");n.className=le.container,e&&dt(n,le["no-transition"]),Sn(n,$v),n.dataset.swal2Theme=t.theme;const i=Yv(t.target||"body");i.appendChild(n),t.topLayer&&(n.setAttribute("popover",""),n.showPopover()),jv(t),Kv(i),qv()},rd=(t,e)=>{t instanceof HTMLElement?e.appendChild(t):typeof t=="object"?Jv(t,e):t&&Sn(e,t)},Jv=(t,e)=>{"jquery"in t?Qv(e,t):Sn(e,t.toString())},Qv=(t,e)=>{if(t.textContent="",0 in e)for(let n=0;n in e;n++)t.appendChild(e[n].cloneNode(!0));else t.appendChild(e.cloneNode(!0))},ex=(t,e)=>{const n=bo(),i=Tr();!n||!i||(!e.showConfirmButton&&!e.showDenyButton&&!e.showCancelButton?en(n):Vt(n),wn(n,e,"actions"),tx(n,i,e),Sn(i,e.loaderHtml||""),wn(i,e,"loader"))};function tx(t,e,n){const i=ii(),s=Bs(),r=Er();!i||!s||!r||(Ol(i,"confirm",n),Ol(s,"deny",n),Ol(r,"cancel",n),nx(i,s,r,n),n.reverseButtons&&(n.toast?(t.insertBefore(r,i),t.insertBefore(s,i)):(t.insertBefore(r,e),t.insertBefore(s,e),t.insertBefore(i,e))))}function nx(t,e,n,i){if(!i.buttonsStyling){Dn([t,e,n],le.styled);return}dt([t,e,n],le.styled),i.confirmButtonColor&&t.style.setProperty("--swal2-confirm-button-background-color",i.confirmButtonColor),i.denyButtonColor&&e.style.setProperty("--swal2-deny-button-background-color",i.denyButtonColor),i.cancelButtonColor&&n.style.setProperty("--swal2-cancel-button-background-color",i.cancelButtonColor),Fl(t),Fl(e),Fl(n)}function Fl(t){const e=window.getComputedStyle(t);if(e.getPropertyValue("--swal2-action-button-focus-box-shadow"))return;const n=e.backgroundColor.replace(/rgba?\((\d+), (\d+), (\d+).*/,"rgba($1, $2, $3, 0.5)");t.style.setProperty("--swal2-action-button-focus-box-shadow",e.getPropertyValue("--swal2-outline").replace(/ rgba\(.*/,` ${n}`))}function Ol(t,e,n){const i=ju(e);wo(t,n[`show${i}Button`],"inline-block"),Sn(t,n[`${e}ButtonText`]||""),t.setAttribute("aria-label",n[`${e}ButtonAriaLabel`]||""),t.className=le[e],wn(t,n,`${e}Button`)}const ix=(t,e)=>{const n=ed();n&&(Sn(n,e.closeButtonHtml||""),wn(n,e,"closeButton"),wo(n,e.showCloseButton),n.setAttribute("aria-label",e.closeButtonAriaLabel||""))},sx=(t,e)=>{const n=rn();n&&(rx(n,e.backdrop),ox(n,e.position),ax(n,e.grow),wn(n,e,"container"))};function rx(t,e){typeof e=="string"?t.style.background=e:e||dt([document.documentElement,document.body],le["no-backdrop"])}function ox(t,e){e&&(e in le?dt(t,le[e]):(sn('The "position" parameter is not valid, defaulting to "center"'),dt(t,le.center)))}function ax(t,e){e&&dt(t,le[`grow-${e}`])}var wt={innerParams:new WeakMap,domCache:new WeakMap};const lx=["input","file","range","select","radio","checkbox","textarea"],cx=(t,e)=>{const n=ft();if(!n)return;const i=wt.innerParams.get(t),s=!i||e.input!==i.input;lx.forEach(r=>{const o=Yi(n,le[r]);o&&(fx(r,e.inputAttributes),o.className=le[r],s&&en(o))}),e.input&&(s&&ux(e),hx(e))},ux=t=>{if(!t.input)return;if(!At[t.input]){Os(`Unexpected type of input! Expected ${Object.keys(At).join(" | ")}, got "${t.input}"`);return}const e=om(t.input);if(!e)return;const n=At[t.input](e,t);Vt(e),t.inputAutoFocus&&setTimeout(()=>{im(n)})},dx=t=>{for(let e=0;e<t.attributes.length;e++){const n=t.attributes[e].name;["id","type","value","style"].includes(n)||t.removeAttribute(n)}},fx=(t,e)=>{const n=ft();if(!n)return;const i=_l(n,t);if(i){dx(i);for(const s in e)i.setAttribute(s,e[s])}},hx=t=>{if(!t.input)return;const e=om(t.input);e&&wn(e,t,"input")},od=(t,e)=>{!t.placeholder&&e.inputPlaceholder&&(t.placeholder=e.inputPlaceholder)},yo=(t,e,n)=>{if(n.inputLabel){const i=document.createElement("label"),s=le["input-label"];i.setAttribute("for",t.id),i.className=s,typeof n.customClass=="object"&&dt(i,n.customClass.inputLabel),i.innerText=n.inputLabel,e.insertAdjacentElement("beforebegin",i)}},om=t=>{const e=ft();if(e)return Yi(e,le[t]||le.input)},Ba=(t,e)=>{["string","number"].includes(typeof e)?t.value=`${e}`:Zu(e)||sn(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof e}"`)},At={};At.text=At.email=At.password=At.number=At.tel=At.url=At.search=At.date=At["datetime-local"]=At.time=At.week=At.month=(t,e)=>{const n=t;return Ba(n,e.inputValue),yo(n,n,e),od(n,e),n.type=e.input,n};At.file=(t,e)=>{const n=t;return yo(n,n,e),od(n,e),n};At.range=(t,e)=>{const n=t,i=n.querySelector("input"),s=n.querySelector("output");return i&&(Ba(i,e.inputValue),i.type=e.input,yo(i,t,e)),s&&Ba(s,e.inputValue),t};At.select=(t,e)=>{const n=t;if(n.textContent="",e.inputPlaceholder){const i=document.createElement("option");Sn(i,e.inputPlaceholder),i.value="",i.disabled=!0,i.selected=!0,n.appendChild(i)}return yo(n,n,e),n};At.radio=t=>{const e=t;return e.textContent="",t};At.checkbox=(t,e)=>{const n=ft();if(!n)throw new Error("Popup not found");const i=_l(n,"checkbox");if(!i)throw new Error("Checkbox input not found");i.value="1",i.checked=!!e.inputValue;const r=t.querySelector("span");if(r){const o=e.inputPlaceholder||e.inputLabel;o&&Sn(r,o)}return i};At.textarea=(t,e)=>{const n=t;Ba(n,e.inputValue),od(n,e),yo(n,n,e);const i=s=>parseInt(window.getComputedStyle(s).marginLeft)+parseInt(window.getComputedStyle(s).marginRight);return setTimeout(()=>{if("MutationObserver"in window){const s=ft();if(!s)return;const r=parseInt(window.getComputedStyle(s).width),o=()=>{if(!document.body.contains(n))return;const a=n.offsetWidth+i(n),l=ft();l&&(a>r?l.style.width=`${a}px`:Ds(l,"width",e.width))};new MutationObserver(o).observe(n,{attributes:!0,attributeFilter:["style"]})}}),n};const px=(t,e)=>{const n=Ju();n&&(id(n),wn(n,e,"htmlContainer"),e.html?(rd(e.html,n),Vt(n,"block")):e.text?(n.textContent=e.text,Vt(n,"block")):en(n),cx(t,e))},mx=(t,e)=>{const n=nm();n&&(id(n),wo(n,!!e.footer,"block"),e.footer&&rd(e.footer,n),wn(n,e,"footer"))},gx=(t,e)=>{const n=wt.innerParams.get(t),i=Mr();if(!i)return;if(n&&e.icon===n.icon){Rf(i,e),Cf(i,e);return}if(!e.icon&&!e.iconHtml){en(i);return}if(e.icon&&Object.keys(Oa).indexOf(e.icon)===-1){Os(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${e.icon}"`),en(i);return}Vt(i),Rf(i,e),Cf(i,e),dt(i,e.showClass&&e.showClass.icon),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",am)},Cf=(t,e)=>{for(const[n,i]of Object.entries(Oa))e.icon!==n&&Dn(t,i);dt(t,e.icon&&Oa[e.icon]),xx(t,e),am(),wn(t,e,"icon")},am=()=>{const t=ft();if(!t)return;const e=window.getComputedStyle(t).getPropertyValue("background-color"),n=t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix");for(let i=0;i<n.length;i++)n[i].style.backgroundColor=e},_x=t=>`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function Sh(){return new ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sl(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function Mh(){return new ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sl(),fragmentShader:`
	...
	`}class Tg extends ti{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new bg(s),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Pr(5,5,5),r=new ai({name:"CubemapFromEquirect",uniforms:yr(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:fn,blending:yi});r.uniforms.tEquirect.value=n;const o=new oi(s,r),a=n.minFilter;return n.minFilter===Cs&&(n.minFilter=Zt),new wE(1,10,this).update(e,o),n.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,n=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(n,i,s);e.setRenderTarget(r)}}function _1(t){let e=new WeakMap,n=new WeakMap,i=null;function s(d,p=!1){return d==null?null:p?o(d):r(d)}function r(d){if(d&&d.isTexture){const p=d.mapping;if(p===kl||p===zl)if(e.has(d)){const _=e.get(d).texture;return a(_,d.mapping)}else{const _=d.image;if(_&&_.height>0){const x=new Tg(_.height);return x.fromEquirectangularTexture(t,d),e.set(d,x),d.addEventListener("dispose",c),a(x.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const p=d.mapping,_=p===kl||p===zl,x=p===Us||p===xr;if(_||x){let m=n.get(d);const h=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==h)return i===null&&(i=new wh(t)),m=_?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),m.texture;if(m!==void 0)return m.texture;{const y=d.image;return _&&y&&y.height>0||x&&y&&l(y)?(i===null&&(i=new wh(t)),m=_?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),d.addEventListener("dispose",u),m.texture):null}}}return d}function a(d,p){return p===kl?d.mapping=Us:p===zl&&(d.mapping=xr),d}function l(d){let p=0;const _=6;for(let x=0;x<_;x++)d[x]!==void 0&&p++;return p===_}function c(d){const p=d.target;p.removeEventListener("dispose",c);const _=e.get(p);_!==void 0&&(e.delete(p),_.dispose())}function u(d){const p=d.target;p.removeEventListener("dispose",u);const _=n.get(p);_!==void 0&&(n.delete(p),_.dispose())}function f(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:f}}function v1(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const s=t.getExtension(i);return e[i]=s,s}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const s=n(i);return s===null&&Ya("WebGLRenderer: "+i+" extension not supported."),s}}}function x1(t,e,n,i){const s={},r=new WeakMap;function o(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",o),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function a(f,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,n.memory.geometries++),d}function l(f){const d=f.attributes;for(const p in d)e.update(d[p],t.ARRAY_BUFFER)}function c(f){const d=[],p=f.index,_=f.attributes.position;let x=0;if(_===void 0)return;if(p!==null){const y=p.array;x=p.version;for(let E=0,A=y.length;E<A;E+=3){const D=y[E+0],R=y[E+1],I=y[E+2];d.push(D,R,R,I,I,D)}}else{const y=_.array;x=_.version;for(let E=0,A=y.length/3-1;E<A;E+=3){const D=E+0,R=E+1,I=E+2;d.push(D,R,R,I,I,D)}}const m=new(_.count>=65535?_g:gg)(d,1);m.version=x;const h=r.get(f);h&&e.remove(h),r.set(f,m)}function u(f){const d=r.get(f);if(d){const p=f.index;p!==null&&d.version<p.version&&c(f)}else c(f);return r.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function b1(t,e,n){let i;function s(d){i=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,p){t.drawElements(i,p,r,d*o),n.update(p,i,1)}function c(d,p,_){_!==0&&(t.drawElementsInstanced(i,p,r,d*o,_),n.update(p,i,_))}function u(d,p,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,r,d,0,_);let m=0;for(let h=0;h<_;h++)m+=p[h];n.update(m,i,1)}function f(d,p,_,x){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let h=0;h<d.length;h++)c(d[h]/o,p[h],x[h]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,r,d,0,x,0,_);let h=0;for(let y=0;y<_;y++)h+=p[y]*x[y];n.update(h,i,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function w1(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(r/3);break;case t.LINES:n.lines+=a*(r/2);break;case t.LINE_STRIP:n.lines+=a*(r-1);break;case t.LINE_LOOP:n.lines+=a*r;break;case t.POINTS:n.points+=a*r;break;default:ct("WebGLInfo: Unknown draw mode:",o);break}}function s(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:s,update:i}}function y1(t,e,n){const i=new WeakMap,s=new Et;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(a);if(d===void 0||d.count!==f){let Q=function(){v.dispose(),i.delete(a),a.removeEventListener("dispose",Q)};var p=Q;d!==void 0&&d.texture.dispose();const _=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,h=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let A=0;_===!0&&(A=1),x===!0&&(A=2),m===!0&&(A=3);let D=a.attributes.position.count*A,R=1;D>e.maxTextureSize&&(R=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const I=new Float32Array(D*R*4*f),v=new hg(I,D,R,f);v.type=Jn,v.needsUpdate=!0;const T=A*4;for(let P=0;P<f;P++){const N=h[P],V=y[P],ee=E[P],X=D*R*4*P;for(let G=0;G<N.count;G++){const O=G*T;_===!0&&(s.fromBufferAttribute(N,G),I[X+O+0]=s.x,I[X+O+1]=s.y,I[X+O+2]=s.z,I[X+O+3]=0),x===!0&&(s.fromBufferAttribute(V,G),I[X+O+4]=s.x,I[X+O+5]=s.y,I[X+O+6]=s.z,I[X+O+7]=0),m===!0&&(s.fromBufferAttribute(ee,G),I[X+O+8]=s.x,I[X+O+9]=s.y,I[X+O+10]=s.z,I[X+O+11]=ee.itemSize===4?s.w:1)}}d={count:f,texture:v,size:new Ye(D,R)},i.set(a,d),a.addEventListener("dispose",Q)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const x=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(t,"morphTargetBaseInfluence",x),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:r}}function S1(t,e,n,i,s){let r=new WeakMap;function o(c){const u=s.render.frame,f=c.geometry,d=e.get(c,f);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==u&&(p.update(),r.set(p,u))}return d}function a(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),i.releaseStatesOfObject(u),n.remove(u.instanceMatrix),u.instanceColor!==null&&n.remove(u.instanceColor)}return{update:o,dispose:a}}const M1={[Km]:"LINEAR_TONE_MAPPING",[Zm]:"REINHARD_TONE_MAPPING",[Jm]:"CINEON_TONE_MAPPING",[Qm]:"ACES_FILMIC_TONE_MAPPING",[tg]:"AGX_TONE_MAPPING",[ng]:"NEUTRAL_TONE_MAPPING",[eg]:"CUSTOM_TONE_MAPPING"};function E1(t,e,n,i,s){const r=new ti(e,n,{type:t,depthBuffer:i,stencilBuffer:s}),o=new ti(e,n,{type:Ei,depthBuffer:!1,stencilBuffer:!1}),a=new Vn;a.setAttribute("position",new bn([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new bn([0,2,0,0,2,0],2));const l=new uE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new oi(a,l),u=new Ed(-1,1,1,-1,0,1);let f=null,d=null,p=!1,_,x=null,m=[],h=!1;this.setSize=function(y,E){r.setSize(y,E),o.setSize(y,E);for(let A=0;A<m.length;A++){const D=m[A];D.setSize&&D.setSize(y,E)}},this.setEffects=function(y){m=y,h=m.length>0&&m[0].isRenderPass===!0;const E=r.width,A=r.height;for(let D=0;D<m.length;D++){const R=m[D];R.setSize&&R.setSize(E,A)}},this.begin=function(y,E){if(p||y.toneMapping===ei&&m.length===0)return!1;if(x=E,E!==null){const A=E.width,D=E.height;(r.width!==A||r.height!==D)&&this.setSize(A,D)}return h===!1&&y.setRenderTarget(r),_=y.toneMapping,y.toneMapping=ei,!0},this.hasRenderPass=function(){return h},this.end=function(y,E){y.toneMapping=_,p=!0;let A=r,D=o;for(let R=0;R<m.length;R++){const I=m[R];if(I.enabled!==!1&&(I.render(y,D,A,E),I.needsSwap!==!1)){const v=A;A=D,D=v}}if(f!==y.outputColorSpace||d!==y.toneMapping){f=y.outputColorSpace,d=y.toneMapping,l.defines={},ot.getTransfer(f)===pt&&(l.defines.SRGB_TRANSFER="");const R=M1[d];R&&(l.defines[R]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,y.setRenderTarget(x),y.render(c,u),x=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),l.dispose()}}const Ag=new Jt,Pu=new ho(1,1),Cg=new hg,Rg=new kM,Pg=new bg,Eh=[],Th=[],Ah=new Float32Array(16),Ch=new Float32Array(9),Rh=new Float32Array(4);function Lr(t,e,n){const i=t[0];if(i<=0||i>0)return t;const s=e*n;let r=Eh[s];if(r===void 0&&(r=new Float32Array(s),Eh[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(r,a)}return r}function Ft(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function Ot(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function Ml(t,e){let n=Th[e];n===void 0&&(n=new Int32Array(e),Th[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function T1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function A1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ft(n,e))return;t.uniform2fv(this.addr,e),Ot(n,e)}}function C1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Ft(n,e))return;t.uniform3fv(this.addr,e),Ot(n,e)}}function R1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ft(n,e))return;t.uniform4fv(this.addr,e),Ot(n,e)}}function P1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ft(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),Ot(n,e)}else{if(Ft(n,i))return;Rh.set(i),t.uniformMatrix2fv(this.addr,!1,Rh),Ot(n,i)}}function L1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ft(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),Ot(n,e)}else{if(Ft(n,i))return;Ch.set(i),t.uniformMatrix3fv(this.addr,!1,Ch),Ot(n,i)}}function D1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ft(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),Ot(n,e)}else{if(Ft(n,i))return;Ah.set(i),t.uniformMatrix4fv(this.addr,!1,Ah),Ot(n,i)}}function I1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function U1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ft(n,e))return;t.uniform2iv(this.addr,e),Ot(n,e)}}function N1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ft(n,e))return;t.uniform3iv(this.addr,e),Ot(n,e)}}function F1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ft(n,e))return;t.uniform4iv(this.addr,e),Ot(n,e)}}function O1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function B1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ft(n,e))return;t.uniform2uiv(this.addr,e),Ot(n,e)}}function k1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ft(n,e))return;t.uniform3uiv(this.addr,e),Ot(n,e)}}function z1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ft(n,e))return;t.uniform4uiv(this.addr,e),Ot(n,e)}}function V1(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s);let r;this.type===t.SAMPLER_2D_SHADOW?(Pu.compareFunction=n.isReversedDepthBuffer()?vd:_d,r=Pu):r=Ag,n.setTexture2D(e||r,s)}function H1(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture3D(e||Rg,s)}function G1(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTextureCube(e||Pg,s)}function W1(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture2DArray(e||Cg,s)}function $1(t){switch(t){case 5126:return T1;case 35664:return A1;case 35665:return C1;case 35666:return R1;case 35674:return P1;case 35675:return L1;case 35676:return D1;case 5124:case 35670:return I1;case 35667:case 35671:return U1;case 35668:case 35672:return N1;case 35669:case 35673:return F1;case 5125:return O1;case 36294:return B1;case 36295:return k1;case 36296:return z1;case 35678:case 36198:case 36298:case 36306:case 35682:return V1;case 35679:case 36299:case 36307:return H1;case 35680:case 36300:case 36308:case 36293:return G1;case 36289:case 36303:case 36311:case 36292:return W1}}function X1(t,e){t.uniform1fv(this.addr,e)}function q1(t,e){const n=Lr(e,this.size,2);t.uniform2fv(this.addr,n)}function Y1(t,e){const n=Lr(e,this.size,3);t.uniform3fv(this.addr,n)}function j1(t,e){const n=Lr(e,this.size,4);t.uniform4fv(this.addr,n)}function K1(t,e){const n=Lr(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function Z1(t,e){const n=Lr(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function J1(t,e){const n=Lr(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function Q1(t,e){t.uniform1iv(this.addr,e)}function eC(t,e){t.uniform2iv(this.addr,e)}function tC(t,e){t.uniform3iv(this.addr,e)}function nC(t,e){t.uniform4iv(this.addr,e)}function iC(t,e){t.uniform1uiv(this.addr,e)}function sC(t,e){t.uniform2uiv(this.addr,e)}function rC(t,e){t.uniform3uiv(this.addr,e)}function oC(t,e){t.uniform4uiv(this.addr,e)}function aC(t,e,n){const i=this.cache,s=e.length,r=Ml(n,s);Ft(i,r)||(t.uniform1iv(this.addr,r),Ot(i,r));let o;this.type===t.SAMPLER_2D_SHADOW?o=Pu:o=Ag;for(let a=0;a!==s;++a)n.setTexture2D(e[a]||o,r[a])}function lC(t,e,n){const i=this.cache,s=e.length,r=Ml(n,s);Ft(i,r)||(t.uniform1iv(this.addr,r),Ot(i,r));for(let o=0;o!==s;++o)n.setTexture3D(e[o]||Rg,r[o])}function cC(t,e,n){const i=this.cache,s=e.length,r=Ml(n,s);Ft(i,r)||(t.uniform1iv(this.addr,r),Ot(i,r));for(let o=0;o!==s;++o)n.setTextureCube(e[o]||Pg,r[o])}function uC(t,e,n){const i=this.cache,s=e.length,r=Ml(n,s);Ft(i,r)||(t.uniform1iv(this.addr,r),Ot(i,r));for(let o=0;o!==s;++o)n.setTexture2DArray(e[o]||Cg,r[o])}function dC(t){switch(t){case 5126:return X1;case 35664:return q1;case 35665:return Y1;case 35666:return j1;case 35674:return K1;case 35675:return Z1;case 35676:return J1;case 5124:case 35670:return Q1;case 35667:case 35671:return eC;case 35668:case 35672:return tC;case 35669:case 35673:return nC;case 5125:return iC;case 36294:return sC;case 36295:return rC;case 36296:return oC;case 35678:case 36198:case 36298:case 36306:case 35682:return aC;case 35679:case 36299:case 36307:return lC;case 35680:case 36300:case 36308:case 36293:return cC;case 36289:case 36303:case 36311:case 36292:return uC}}class fC{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=$1(n.type)}}class hC{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=dC(n.type)}}class pC{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,n[a.id],i)}}}const vc=/(\w+)(\])?(\[|\.)?/g;function Ph(t,e){t.seq.push(e),t.map[e.id]=e}function mC(t,e,n){const i=t.name,s=i.length;for(vc.lastIndex=0;;){const r=vc.exec(i),o=vc.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){Ph(n,c===void 0?new fC(a,t,e):new hC(a,t,e));break}else{let f=n.map[a];f===void 0&&(f=new pC(a),Ph(n,f)),n=f}}}class Ta{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(n,o),l=e.getUniformLocation(n,a.name);mC(a,l,this)}const s=[],r=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,n,i,s){const r=this.map[n];r!==void 0&&r.setValue(e,i,s)}setOptional(e,n,i){const s=n[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,n,i,s){for(let r=0,o=n.length;r!==o;++r){const a=n[r],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,n){const i=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in n&&i.push(o)}return i}}function Lh(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const gC=37297;let _C=0;function vC(t,e){const n=t.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,n.length);for(let o=s;o<r;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const Dh=new je;function xC(t){ot._getMatrix(Dh,ot.workingColorSpace,t);const e=`mat3( ${Dh.elements.map(n=>n.toFixed(4))} )`;switch(ot.getTransfer(t)){case qa:return[e,"LinearTransferOETF"];case pt:return[e,"sRGBTransferOETF"];default:return Ge("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Ih(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=(t.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return n.toUpperCase()+`

`+r+`

`+vC(t.getShaderSource(e),a)}else return r}function bC(t,e){const n=xC(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const wC={[Km]:"Linear",[Zm]:"Reinhard",[Jm]:"Cineon",[Qm]:"ACESFilmic",[tg]:"AgX",[ng]:"Neutral",[eg]:"Custom"};function yC(t,e){const n=wC[e];return n===void 0?(Ge("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const ca=new W;function SC(){ot.getLuminanceCoefficients(ca);const t=ca.x.toFixed(4),e=ca.y.toFixed(4),n=ca.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function MC(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yr).join(`
`)}function EC(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function TC(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),o=r.name;let a=1;r.type===t.FLOAT_MAT2&&(a=2),r.type===t.FLOAT_MAT3&&(a=3),r.type===t.FLOAT_MAT4&&(a=4),n[o]={type:r.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function Yr(t){return t!==""}function Uh(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Nh(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const AC=/^[ \t]*#include +<([\w\d./]+)>/gm;function Lu(t){return t.replace(AC,RC)}const CC=new Map;function RC(t,e){let n=Ke[e];if(n===void 0){const i=CC.get(e);if(i!==void 0)n=Ke[i],Ge('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Lu(n)}const PC=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fh(t){return t.replace(PC,LC)}function LC(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Oh(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const DC={[ba]:"SHADOWMAP_TYPE_PCF",[qr]:"SHADOWMAP_TYPE_VSM"};function IC(t){return DC[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const UC={[Us]:"ENVMAP_TYPE_CUBE",[xr]:"ENVMAP_TYPE_CUBE",[bl]:"ENVMAP_TYPE_CUBE_UV"};function NC(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":UC[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const FC={[xr]:"ENVMAP_MODE_REFRACTION"};function OC(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":FC[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const BC={[jm]:"ENVMAP_BLENDING_MULTIPLY",[_M]:"ENVMAP_BLENDING_MIX",[vM]:"ENVMAP_BLENDING_ADD"};function kC(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":BC[t.combine]||"ENVMAP_BLENDING_NONE"}function zC(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function VC(t,e,n,i){const s=t.getContext(),r=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=IC(n),c=NC(n),u=OC(n),f=kC(n),d=zC(n),p=MC(n),_=EC(r),x=s.createProgram();let m,h,y=n.glslVersion?"#version "+n.glslVersion+`
