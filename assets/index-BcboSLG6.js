...
*/function Gp(t,e,n){if(typeof t=="function"?t===e:t.has(e))return arguments.length<3?e:n;throw new TypeError("Private element is not present on this object")}function xv(t,e){if(e.has(t))throw new TypeError("Cannot initialize the same private elements twice on an object")}function Sf(t,e){return t.get(Gp(t,e))}function bv(t,e,n){xv(t,e),e.set(t,n)}function wv(t,e,n){return t.set(Gp(t,e),n),n}const yv=100,Fe={},Sv=()=>{Fe.previousActiveElement instanceof HTMLElement?(Fe.previousActiveElement.focus(),Fe.previousActiveElement=null):document.body&&document.body.focus()},Mv=t=>new Promise(e=>{if(!t)return e();const n=window.scrollX,i=window.scrollY;Fe.restoreFocusTimeout=setTimeout(()=>{Sv(),e()},yv),window.scrollTo(n,i)}),Wp="swal2-",Ev=["container","shown","height-auto","iosfix","popup","modal","no-backdrop","no-transition","toast","toast-shown","show","hide","close","title","html-container","actions","confirm","deny","cancel","footer","icon","icon-content","image","input","file","range","select","radio","checkbox","label","textarea","inputerror","input-label","validation-message","progress-steps","active-progress-step","progress-step","progress-step-line","loader","loading","styled","top","top-start","top-end","top-left","top-right","center","center-start","center-end","center-left","center-right","bottom","bottom-start","bottom-end","bottom-left","bottom-right","grow-row","grow-column","grow-fullscreen","rtl","timer-progress-bar","timer-progress-bar-container","scrollbar-measure","icon-success","icon-warning","icon-info","icon-question","icon-error","draggable","dragging"],se=Ev.reduce((t,e)=>(t[e]=Wp+e,t),{}),Tv=["success","warning","info","question","error"],La=Tv.reduce((t,e)=>(t[e]=Wp+e,t),{}),$p="SweetAlert2:",Wu=t=>t.charAt(0).toUpperCase()+t.slice(1),sn=t=>{console.warn(`${$p} ${typeof t=="object"?t.join(" "):t}`)},Ds=t=>{console.error(`${$p} ${t}`)},Mf=[],Av=t=>{Mf.includes(t)||(Mf.push(t),sn(t))},Xp=(t,e=null)=>{Av(`"${t}" is deprecated and will be removed in the next major release.${e?` Use "${e}" instead.`:""}`)},rl=t=>typeof t=="function"?t():t,$u=t=>t&&typeof t.toPromise=="function",go=t=>$u(t)?t.toPromise():Promise.resolve(t),Xu=t=>t&&Promise.resolve(t)===t,rn=()=>document.body.querySelector(`.${se.container}`),_o=t=>{const e=rn();return e?e.querySelector(t):null},wn=t=>_o(`.${t}`),dt=()=>wn(se.popup),Mr=()=>wn(se.icon),Cv=()=>wn(se["icon-content"]),qp=()=>wn(se.title),qu=()=>wn(se["html-container"]),Yp=()=>wn(se.image),Yu=()=>wn(se["progress-steps"]),ol=()=>wn(se["validation-message"]),si=()=>_o(`.${se.actions} .${se.confirm}`),Er=()=>_o(`.${se.actions} .${se.cancel}`),Is=()=>_o(`.${se.actions} .${se.deny}`),Rv=()=>wn(se["input-label"]),Tr=()=>_o(`.${se.loader}`),vo=()=>wn(se.actions),jp=()=>wn(se.footer),al=()=>wn(se["timer-progress-bar"]),ju=()=>wn(se.close),Pv=`
  ...
  video[controls],
  summary
`,Ku=()=>{const t=dt();if(!t)return[];const e=t.querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),n=Array.from(e).sort((r,o)=>{const a=parseInt(r.getAttribute("tabindex")||"0"),l=parseInt(o.getAttribute("tabindex")||"0");return a>l?1:a<l?-1:0}),i=t.querySelectorAll(Pv),s=Array.from(i).filter(r=>r.getAttribute("tabindex")!=="-1");return[...new Set(n.concat(s))].filter(r=>un(r))},Zu=()=>wi(document.body,se.shown)&&!wi(document.body,se["toast-shown"])&&!wi(document.body,se["no-backdrop"]),ll=()=>{const t=dt();return t?wi(t,se.toast):!1},Lv=()=>{const t=dt();return t?t.hasAttribute("data-loading"):!1},yn=(t,e)=>{if(t.textContent="",e){const i=new DOMParser().parseFromString(e,"text/html"),s=i.querySelector("head");s&&Array.from(s.childNodes).forEach(o=>{t.appendChild(o)});const r=i.querySelector("body");r&&Array.from(r.childNodes).forEach(o=>{o instanceof HTMLVideoElement||o instanceof HTMLAudioElement?t.appendChild(o.cloneNode(!0)):t.appendChild(o)})}},wi=(t,e)=>{if(!e)return!1;const n=e.split(/\s+/);for(let i=0;i<n.length;i++)if(!t.classList.contains(n[i]))return!1;return!0},Dv=(t,e)=>{Array.from(t.classList).forEach(n=>{!Object.values(se).includes(n)&&!Object.values(La).includes(n)&&!Object.values(e.showClass||{}).includes(n)&&t.classList.remove(n)})},bn=(t,e,n)=>{if(Dv(t,e),!e.customClass)return;const i=e.customClass[n];if(i){if(typeof i!="string"&&!i.forEach){sn(`Invalid type of customClass.${n}! Expected string or iterable object, got "${typeof i}"`);return}ut(t,i)}},cl=(t,e)=>{if(!e)return null;switch(e){case"select":case"textarea":case"file":return t.querySelector(`.${se.popup} > .${se[e]}`);case"checkbox":return t.querySelector(`.${se.popup} > .${se.checkbox} input`);case"radio":return t.querySelector(`.${se.popup} > .${se.radio} input:checked`)||t.querySelector(`.${se.popup} > .${se.radio} input:first-child`);case"range":return t.querySelector(`.${se.popup} > .${se.range} input`);default:return t.querySelector(`.${se.popup} > .${se.input}`)}},Kp=t=>{if(t.focus(),t.type!=="file"){const e=t.value;t.value="",t.value=e}},Zp=(t,e,n)=>{!t||!e||(typeof e=="string"&&(e=e.split(/\s+/).filter(Boolean)),e.forEach(i=>{Array.isArray(t)?t.forEach(s=>{n?s.classList.add(i):s.classList.remove(i)}):n?t.classList.add(i):t.classList.remove(i)}))},ut=(t,e)=>{Zp(t,e,!0)},Ln=(t,e)=>{Zp(t,e,!1)},$i=(t,e)=>{const n=Array.from(t.children);for(let i=0;i<n.length;i++){const s=n[i];if(s instanceof HTMLElement&&wi(s,e))return s}},As=(t,e,n)=>{n===`${parseInt(`${n}`)}`&&(n=parseInt(n)),n||parseInt(`${n}`)===0?t.style.setProperty(e,typeof n=="number"?`${n}px`:n):t.style.removeProperty(e)},Ot=(t,e="flex")=>{t&&(t.style.display=e)},Jt=t=>{t&&(t.style.display="none")},Ju=(t,e="block")=>{t&&new MutationObserver(()=>{xo(t,t.innerHTML,e)}).observe(t,{childList:!0,subtree:!0})},Ef=(t,e,n,i)=>{const s=t.querySelector(e);s&&s.style.setProperty(n,i)},xo=(t,e,n="flex")=>{e?Ot(t,n):Jt(t)},un=t=>!!(t&&(t.offsetWidth||t.offsetHeight||t.getClientRects().length)),Iv=()=>!un(si())&&!un(Is())&&!un(Er()),Tc=t=>t.scrollHeight>t.clientHeight,Uv=(t,e)=>{let n=t;for(;n&&n!==e;){if(Tc(n))return!0;n=n.parentElement}return!1},Jp=t=>{const e=window.getComputedStyle(t),n=parseFloat(e.getPropertyValue("animation-duration")||"0"),i=parseFloat(e.getPropertyValue("transition-duration")||"0");return n>0||i>0},Qu=(t,e=!1)=>{const n=al();n&&un(n)&&(e&&(n.style.transition="none",n.style.width="100%"),setTimeout(()=>{n.style.transition=`width ${t/1e3}s linear`,n.style.width="0%"},10))},Nv=()=>{const t=al();if(!t)return;const e=parseInt(window.getComputedStyle(t).width);t.style.removeProperty("transition"),t.style.width="100%";const n=parseInt(window.getComputedStyle(t).width),i=e/n*100;t.style.width=`${i}%`},Fv=()=>typeof window>"u"||typeof document>"u",Ov=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function N1(t,e,n){const i=new Float32Array(xs),s=new G(0,1,0);return new li({name:"SphericalGaussianBlur",defines:{n:xs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:pl(),fragmentShader:`
	...
	`}class _g extends ti{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new dg(s),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new ai(a,l),u=new bd(-1,1,1,-1,0,1);let f=null,d=null,p=!1,_,x=null,m=[],h=!1;this.setSize=function(E,M){r.setSize(E,M),o.setSize(E,M);for(let w=0;w<m.length;w++){const C=m[w];C.setSize&&C.setSize(E,M)}},this.setEffects=function(E){m=E,h=m.length>0&&m[0].isRenderPass===!0;const M=r.width,w=r.height;for(let C=0;C<m.length;C++){const A=m[C];A.setSize&&A.setSize(M,w)}},this.begin=function(E,M){if(p||E.toneMapping===ei&&m.length===0)return!1;if(x=M,M!==null){const w=M.width,C=M.height;(r.width!==w||r.height!==C)&&this.setSize(w,C)}return h===!1&&E.setRenderTarget(r),_=E.toneMapping,E.toneMapping=ei,!0},this.hasRenderPass=function(){return h},this.end=function(E,M){E.toneMapping=_,p=!0;let w=r,C=o;for(let A=0;A<m.length;A++){const D=m[A];if(D.enabled!==!1&&(D.render(E,C,w,M),D.needsSwap!==!1)){const v=w;w=C,C=v}}if(f!==E.outputColorSpace||d!==E.toneMapping){f=E.outputColorSpace,d=E.toneMapping,l.defines={},ot.getTransfer(f)===pt&&(l.defines.SRGB_TRANSFER="");const A=G1[d];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=w.texture,E.setRenderTarget(x),E.render(c,u),x=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),l.dispose()}}const vg=new Kt,wu=new uo(1,1),xg=new sg,bg=new sE,wg=new dg,yh=[],Sh=[],Mh=new Float32Array(16),Eh=new Float32Array(9),Th=new Float32Array(4);function Lr(t,e,n){const i=t[0];if(i<=0||i>0)return t;const s=e*n;let r=yh[s];if(r===void 0&&(r=new Float32Array(s),yh[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(r,a)}return r}function Dt(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function It(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function ml(t,e){let n=Sh[e];n===void 0&&(n=new Int32Array(e),Sh[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function $1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function X1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Dt(n,e))return;t.uniform2fv(this.addr,e),It(n,e)}}function q1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Dt(n,e))return;t.uniform3fv(this.addr,e),It(n,e)}}function Y1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Dt(n,e))return;t.uniform4fv(this.addr,e),It(n,e)}}function j1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Dt(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),It(n,e)}else{if(Dt(n,i))return;Th.set(i),t.uniformMatrix2fv(this.addr,!1,Th),It(n,i)}}function K1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Dt(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),It(n,e)}else{if(Dt(n,i))return;Eh.set(i),t.uniformMatrix3fv(this.addr,!1,Eh),It(n,i)}}function Z1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Dt(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),It(n,e)}else{if(Dt(n,i))return;Mh.set(i),t.uniformMatrix4fv(this.addr,!1,Mh),It(n,i)}}function J1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function Q1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Dt(n,e))return;t.uniform2iv(this.addr,e),It(n,e)}}function eC(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Dt(n,e))return;t.uniform3iv(this.addr,e),It(n,e)}}function tC(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Dt(n,e))return;t.uniform4iv(this.addr,e),It(n,e)}}function nC(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function iC(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Dt(n,e))return;t.uniform2uiv(this.addr,e),It(n,e)}}function sC(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Dt(n,e))return;t.uniform3uiv(this.addr,e),It(n,e)}}function rC(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Dt(n,e))return;t.uniform4uiv(this.addr,e),It(n,e)}}function oC(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s);let r;this.type===t.SAMPLER_2D_SHADOW?(wu.compareFunction=n.isReversedDepthBuffer()?hd:fd,r=wu):r=vg,n.setTexture2D(e||r,s)}function aC(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture3D(e||bg,s)}function lC(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTextureCube(e||wg,s)}function cC(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture2DArray(e||xg,s)}function uC(t){switch(t){case 5126:return $1;case 35664:return X1;case 35665:return q1;case 35666:return Y1;case 35674:return j1;case 35675:return K1;case 35676:return Z1;case 5124:case 35670:return J1;case 35667:case 35671:return Q1;case 35668:case 35672:return eC;case 35669:case 35673:return tC;case 5125:return nC;case 36294:return iC;case 36295:return sC;case 36296:return rC;case 35678:case 36198:case 36298:case 36306:case 35682:return oC;case 35679:case 36299:case 36307:return aC;case 35680:case 36300:case 36308:case 36293:return lC;case 36289:case 36303:case 36311:case 36292:return cC}}function dC(t,e){t.uniform1fv(this.addr,e)}function fC(t,e){const n=Lr(e,this.size,2);t.uniform2fv(this.addr,n)}function hC(t,e){const n=Lr(e,this.size,3);t.uniform3fv(this.addr,n)}function pC(t,e){const n=Lr(e,this.size,4);t.uniform4fv(this.addr,n)}function mC(t,e){const n=Lr(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function gC(t,e){const n=Lr(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function _C(t,e){const n=Lr(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function vC(t,e){t.uniform1iv(this.addr,e)}function xC(t,e){t.uniform2iv(this.addr,e)}function bC(t,e){t.uniform3iv(this.addr,e)}function wC(t,e){t.uniform4iv(this.addr,e)}function yC(t,e){t.uniform1uiv(this.addr,e)}function SC(t,e){t.uniform2uiv(this.addr,e)}function MC(t,e){t.uniform3uiv(this.addr,e)}function EC(t,e){t.uniform4uiv(this.addr,e)}function TC(t,e,n){const i=this.cache,s=e.length,r=ml(n,s);Dt(i,r)||(t.uniform1iv(this.addr,r),It(i,r));let o;this.type===t.SAMPLER_2D_SHADOW?o=wu:o=vg;for(let a=0;a!==s;++a)n.setTexture2D(e[a]||o,r[a])}function AC(t,e,n){const i=this.cache,s=e.length,r=ml(n,s);Dt(i,r)||(t.uniform1iv(this.addr,r),It(i,r));for(let o=0;o!==s;++o)n.setTexture3D(e[o]||bg,r[o])}function CC(t,e,n){const i=this.cache,s=e.length,r=ml(n,s);Dt(i,r)||(t.uniform1iv(this.addr,r),It(i,r));for(let o=0;o!==s;++o)n.setTextureCube(e[o]||wg,r[o])}function RC(t,e,n){const i=this.cache,s=e.length,r=ml(n,s);Dt(i,r)||(t.uniform1iv(this.addr,r),It(i,r));for(let o=0;o!==s;++o)n.setTexture2DArray(e[o]||xg,r[o])}function PC(t){switch(t){case 5126:return dC;case 35664:return fC;case 35665:return hC;case 35666:return pC;case 35674:return mC;case 35675:return gC;case 35676:return _C;case 5124:case 35670:return vC;case 35667:case 35671:return xC;case 35668:case 35672:return bC;case 35669:case 35673:return wC;case 5125:return yC;case 36294:return SC;case 36295:return MC;case 36296:return EC;case 35678:case 36198:case 36298:case 36306:case 35682:return TC;case 35679:case 36299:case 36307:return AC;case 35680:case 36300:case 36308:case 36293:return CC;case 36289:case 36303:case 36311:case 36292:return RC}}class LC{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=uC(n.type)}}class DC{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=PC(n.type)}}class IC{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,n[a.id],i)}}}const cc=/(\w+)(\])?(\[|\.)?/g;function Ah(t,e){t.seq.push(e),t.map[e.id]=e}function UC(t,e,n){const i=t.name,s=i.length;for(cc.lastIndex=0;;){const r=cc.exec(i),o=cc.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){Ah(n,c===void 0?new LC(a,t,e):new DC(a,t,e));break}else{let f=n.map[a];f===void 0&&(f=new IC(a),Ah(n,f)),n=f}}}class wa{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(n,o),l=e.getUniformLocation(n,a.name);UC(a,l,this)}const s=[],r=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,n,i,s){const r=this.map[n];r!==void 0&&r.setValue(e,i,s)}setOptional(e,n,i){const s=n[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,n,i,s){for(let r=0,o=n.length;r!==o;++r){const a=n[r],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,n){const i=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in n&&i.push(o)}return i}}function Ch(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const NC=37297;let FC=0;function OC(t,e){const n=t.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,n.length);for(let o=s;o<r;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const Rh=new je;function BC(t){ot._getMatrix(Rh,ot.workingColorSpace,t);const e=`mat3( ${Rh.elements.map(n=>n.toFixed(4))} )`;switch(ot.getTransfer(t)){case za:return[e,"LinearTransferOETF"];case pt:return[e,"sRGBTransferOETF"];default:return We("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Ph(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=(t.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return n.toUpperCase()+`

`+r+`

`+OC(t.getShaderSource(e),a)}else return r}function kC(t,e){const n=BC(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const zC={[Vm]:"Linear",[Hm]:"Reinhard",[Gm]:"Cineon",[Wm]:"ACESFilmic",[Xm]:"AgX",[qm]:"Neutral",[$m]:"Custom"};function VC(t,e){const n=zC[e];return n===void 0?(We("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const oa=new G;function HC(){ot.getLuminanceCoefficients(oa);const t=oa.x.toFixed(4),e=oa.y.toFixed(4),n=oa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function GC(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter($r).join(`
`)}function WC(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function $C(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),o=r.name;let a=1;r.type===t.FLOAT_MAT2&&(a=2),r.type===t.FLOAT_MAT3&&(a=3),r.type===t.FLOAT_MAT4&&(a=4),n[o]={type:r.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function $r(t){return t!==""}function Lh(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Dh(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const XC=/^[ \t]*#include +<([\w\d./]+)>/gm;function yu(t){return t.replace(XC,YC)}const qC=new Map;function YC(t,e){let n=Ke[e];if(n===void 0){const i=qC.get(e);if(i!==void 0)n=Ke[i],We('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return yu(n)}const jC=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ih(t){return t.replace(jC,KC)}function KC(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Uh(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const ZC={[ma]:"SHADOWMAP_TYPE_PCF",[Wr]:"SHADOWMAP_TYPE_VSM"};function JC(t){return ZC[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const QC={[Rs]:"ENVMAP_TYPE_CUBE",[vr]:"ENVMAP_TYPE_CUBE",[dl]:"ENVMAP_TYPE_CUBE_UV"};function e2(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":QC[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const t2={[vr]:"ENVMAP_MODE_REFRACTION"};function n2(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":t2[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const i2={[zm]:"ENVMAP_BLENDING_MULTIPLY",[FM]:"ENVMAP_BLENDING_MIX",[OM]:"ENVMAP_BLENDING_ADD"};function s2(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":i2[t.combine]||"ENVMAP_BLENDING_NONE"}function r2(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function o2(t,e,n,i){const s=t.getContext(),r=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=JC(n),c=e2(n),u=n2(n),f=s2(n),d=r2(n),p=GC(n),_=WC(r),x=s.createProgram();let m,h,E=n.glslVersion?"#version "+n.glslVersion+`
